...
यह टेम्पलेट SingleStoreDB और OpenAI का उपयोग करके RAG (Retrieval Augmented Generation) करता है।

## वातावरण सेटअप

इस टेम्पलेट में SingleStoreDB को एक वेक्टर स्टोर के रूप में उपयोग किया जाता है और यह आवश्यक है कि `SINGLESTOREDB_URL` सेट किया जाए। यह `admin:password@svc-xxx.svc.singlestore.com:port/db_name` के रूप में होना चाहिए।
...
हम [http://127.0.0.1:8000/rag-singlestoredb/playground](http://127.0.0.1:8000/rag-singlestoredb/playground) पर खेल सकते हैं।
