...
यह टेम्पलेट वेक्टारा के साथ बहु-प्रश्न RAG को करता है।
...
हम [http://127.0.0.1:8000/rag-vectara-multiquery/playground](http://127.0.0.1:8000/rag-vectara-multiquery/playground) पर खेल सकते हैं।
