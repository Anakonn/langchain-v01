...
यह टेम्पलेट LanceDB और OpenAI का उपयोग करके RAG करता है।

## Environment Setup

OpenAI मॉडल्स तक पहुंच के लिए `OPENAI_API_KEY` environment variable सेट करें।
...
हम [http://127.0.0.1:8000/rag-lancedb/playground](http://127.0.0.1:8000/rag-lancedb/playground) पर खेल सकते हैं।
