...
# पुनर्लेखन_पुनर्प्राप्ति_पढ़ना

यह टेम्पलेट [पुनर्प्राप्ति-सहायक बड़े भाषा मॉडलों](https://arxiv.org/pdf/2305.14283.pdf) के लिए RAG को अनुकूलित करने के लिए क्वेरी रूपांतरण (पुनर्लेखन) के लिए एक विधि को लागू करता है।

## वातावरण सेटअप

OpenAI मॉडलों तक पहुंच के लिए `OPENAI_API_KEY` पर्यावरण चर सेट करें।
...
हम [http://127.0.0.1:8000/rewrite_retrieve_read/playground](http://127.0.0.1:8000/rewrite_retrieve_read/playground) पर खेल सकते हैं।
