...
ऐसे कुछ उपकरण हैं जिन पर हम अकेले मॉडल को निष्पादित करने पर भरोसा नहीं करते हैं। ऐसी स्थितियों में हम कर सकते हैं कि उपकरण को शुरू करने से पहले मानव अनुमोदन की आवश्यकता हो।

## सेटअप

हमें निम्नलिखित पैकेज इंस्टॉल करने की आवश्यकता होगी:

```python
%pip install --upgrade --quiet langchain
```

और इन पर्यावरण चर सेट करें:
...
मान लीजिए कि हमारे पास निम्नलिखित (डमी) उपकरण और उपकरण-कॉलिंग श्रृंखला हैं:
...
हम अपने tool_chain फ़ंक्शन में एक सरल मानव अनुमोदन चरण जोड़ सकते हैं:
