...
अक्सर प्रश्न-उत्तर अनुप्रयोगों में यह महत्वपूर्ण होता है कि उपयोगकर्ताओं को वह स्रोत दिखाया जाए जिसका उपयोग उत्तर जनरेट करने के लिए किया गया था। इसका सबसे सरल तरीका यह है कि श्रृंखला प्रत्येक जनरेशन में पुनर्प्राप्त किए गए दस्तावेज़ों को वापस लौटाए।

हम [LLM Powered Autonomous Agents](https://lilianweng.github.io/posts/2023-06-23-agent/) ब्लॉग पोस्ट द्वारा Lilian Weng के [Returning sources](/docs/use_cases/question_answering/sources) गाइड में बनाए गए प्रश्न-उत्तर ऐप के साथ काम करेंगे।

## सेटअप

### निर्भरताएं

इस वॉकथ्रू में हम OpenAI चैट मॉडल और एम्बेडिंग्स और Chroma वेक्टर स्टोर का उपयोग करेंगे, लेकिन यहां दिखाया गया सब कुछ किसी भी [ChatModel](/docs/modules/model_io/chat/) या [LLM](/docs/modules/model_io/llms/), [Embeddings](/docs/modules/data_connection/text_embedding/), और [VectorStore](/docs/modules/data_connection/vectorstores/) या [Retriever](/docs/modules/data_connection/retrievers/) के साथ काम करता है।
...
ध्यान दें कि LangSmith आवश्यक नहीं है, लेकिन यह उपयोगी है। यदि आप LangSmith का उपयोग करना चाहते हैं, तो उपर्युक्त लिंक पर साइन अप करने के बाद, ट्रेस लॉग करना शुरू करने के लिए अपने पर्यावरण चरों को सेट करना सुनिश्चित करें:
...
## स्रोतों के साथ श्रृंखला

यहां [LLM Powered Autonomous Agents](https://lilianweng.github.io/posts/2023-06-23-agent/) ब्लॉग पोस्ट द्वारा Lilian Weng के [Returning sources](/docs/use_cases/question_answering/sources) गाइड में बनाए गए प्रश्न-उत्तर ऐप है:
...
## अंतिम आउटपुट स्ट्रीमिंग

LCEL के साथ अंतिम आउटपुट स्ट्रीम करना आसान है:
...
हम अपने स्ट्रीम को जैसे-जैसे वापस लौटाया जा रहा है, उसे संकलित करने के लिए कुछ तर्क जोड़ सकते हैं:
...
## मध्यवर्ती चरणों का स्ट्रीमिंग

मान लीजिए कि हम न केवल श्रृंखला के अंतिम आउटपुट को, बल्कि कुछ मध्यवर्ती चरणों को भी स्ट्रीम करना चाहते हैं। उदाहरण के लिए, हमारी [Chat history](/docs/use_cases/question_answering/chat_history) श्रृंखला लें। यहां हम उपयोगकर्ता के प्रश्न को पुनर्प्रारूपित करते हैं, लेकिन इसे अंतिम आउटपुट का हिस्सा नहीं बनाया जाता है। हम अपनी श्रृंखला को नया प्रश्न वापस करने के लिए संशोधित कर सकते हैं, लेकिन प्रदर्शन उद्देश्यों के लिए हम इसे वैसा ही छोड़ देंगे।
...
मध्यवर्ती चरणों को स्ट्रीम करने के लिए हम `astream_log` विधि का उपयोग करेंगे। यह एक असिंक्रोनस विधि है जो JSONPatch ऑपरेशन उत्पन्न करती है जो उसी क्रम में लागू किए जाने पर RunState को बनाते हैं:
...
आप सभी चरण (डिफ़ॉल्ट) या नाम, टैग या मेटाडेटा द्वारा शामिल/अपवर्जित चरण स्ट्रीम कर सकते हैं। इस मामले में, हम केवल `contextualize_q_chain` का हिस्सा और अंतिम आउटपुट के मध्यवर्ती चरण स्ट्रीम करेंगे। ध्यान दें कि जब हम `contextualize_q_chain` को परिभाषित कर रहे थे, तो हमने इसे एक संबंधित टैग दिया था, जिसका अब हम फ़िल्टर कर सकते हैं।

पठनीयता के लिए हम केवल स्ट्रीम के पहले 20 टुकड़े दिखाते हैं:
...
यदि हम अपने पुनर्प्राप्त दस्तावेज़ प्राप्त करना चाहते हैं, तो हम "Retriever" नाम पर फ़िल्टर कर सकते हैं:
...
मध्यवर्ती चरणों को कैसे स्ट्रीम करें, इस बारे में अधिक जानकारी के लिए [LCEL Interface](/docs/expression_language/interface#async-stream-intermediate-steps) दस्तावेज़ देखें।
