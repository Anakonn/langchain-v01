...
# Hugging Face प्रॉम्प्ट इंजेक्शन पहचान

यह नोटबुक दिखाता है कि कैसे `HuggingFace` से टेक्स्ट क्लासिफिकेशन मॉडल का उपयोग करके प्रॉम्प्ट इंजेक्शन हमलों से बचा जा सकता है।

डिफ़ॉल्ट रूप से, यह *[protectai/deberta-v3-base-prompt-injection-v2](https://huggingface.co/protectai/deberta-v3-base-prompt-injection-v2)* मॉडल का उपयोग करता है जो प्रॉम्प्ट इंजेक्शन की पहचान करने के लिए प्रशिक्षित है।

इस नोटबुक में, हम तेज़ी से अनुमान लगाने के लिए मॉडल के ONNX संस्करण का उपयोग करेंगे।

## उपयोग

पहले, हमें `optimum` लाइब्रेरी को इंस्टॉल करना होगा जो ONNX मॉडल्स को चलाने के लिए उपयोग किया जाता है:
...
आइए मानक क्वेरी को LLM को सत्यापित करें। इसे बिना किसी बदलाव के वापस किया जाना चाहिए:
...
अब हम दुर्भावनापूर्ण क्वेरी को सत्यापित कर सकते हैं। **त्रुटि उत्पन्न होनी चाहिए!**
