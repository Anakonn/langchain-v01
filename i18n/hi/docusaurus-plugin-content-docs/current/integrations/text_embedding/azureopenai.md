...
चलिए Azure OpenAI Embedding क्लास को लोड करते हैं जिसमें माहौल के चर Azure एंडपॉइंट का उपयोग करने के लिए सेट किए गए हैं।
...
## [Legacy] जब `openai<1` का उपयोग किया जा रहा है
