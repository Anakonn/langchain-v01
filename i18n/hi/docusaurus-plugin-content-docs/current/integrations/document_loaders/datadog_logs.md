...
यह लोडर आपके डेटाडॉग एप्लिकेशन से लॉग्स को `datadog_api_client` पायथन पैकेज का उपयोग करके फेच करता है। आपको लोडर को अपने `डेटाडॉग API कुंजी` और `एप्प कुंजी` के साथ इनिशियलाइज़ करना होगा, और आपको इच्छित लॉग्स को एक्सट्रैक्ट करने के लिए क्वेरी पास करनी होगी।
