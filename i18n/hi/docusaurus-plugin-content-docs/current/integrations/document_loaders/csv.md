...
>एक [कॉमा-अलग मूल्य (CSV)](https://en.wikipedia.org/wiki/Comma-separated_values) फ़ाइल एक विभाजित पाठ फ़ाइल है जो मूल्यों को अलग करने के लिए कॉमा का उपयोग करती है। फ़ाइल की प्रत्येक पंक्ति एक डेटा रिकॉर्ड है। प्रत्येक रिकॉर्ड में एक या अधिक फ़ील्ड होते हैं, जो कॉमा से अलग होते हैं।

एक ही दस्तावेज़ प्रति पंक्ति के साथ [csv](https://en.wikipedia.org/wiki/Comma-separated_values) डेटा लोड करें।
...
## csv पार्सिंग और लोडिंग को अनुकूलित करना

अधिक जानकारी के लिए [csv मॉड्यूल](https://docs.python.org/3/library/csv.html) प्रलेखन देखें कि कौन से csv तर्क समर्थित हैं।
...
## दस्तावेज़ स्रोत को पहचानने के लिए कॉलम निर्दिष्ट करें

`source_column` तर्क का उपयोग करें कि प्रत्येक पंक्ति से बनाए गए दस्तावेज़ के लिए एक स्रोत निर्दिष्ट करें। अन्यथा `file_path` सभी दस्तावेज़ों के लिए स्रोत के रूप में उपयोग किया जाएगा जो CSV फ़ाइल से लोड किए गए हैं।

यह स्रोतों का उपयोग करके प्रश्नों का उत्तर देने वाली श्रृंखलाओं के लिए उपयोगी है।
...
आप टेबल को `UnstructuredCSVLoader` का उपयोग करके भी लोड कर सकते हैं। `UnstructuredCSVLoader` का उपयोग करने का एक लाभ यह है कि यदि आप इसका उपयोग `"elements"` मोड में करते हैं, तो टेबल का एचटीएमएल प्रतिनिधित्व मेटाडेटा में उपलब्ध होगा।
