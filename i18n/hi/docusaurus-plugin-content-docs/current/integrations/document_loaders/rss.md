...
यह कवर करता है कि कैसे HTML समाचार लेख एक सूची से RSS फ़ीड URL से एक दस्तावेज़ प्रारूप में लोड किया जाए जिसका हम आगे उपयोग कर सकते हैं।
...
आप NewsURLLoader में तर्क पास कर सकते हैं जिसका उपयोग वह लेख लोड करने के लिए करता है।
...
आप एक OPML फ़ाइल जैसे Feedly निर्यात का भी उपयोग कर सकते हैं। या तो URL या OPML सामग्री पास करें।
