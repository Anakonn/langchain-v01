...
यह नोटबुक `langchain_community.document_loaders.ArcGISLoader` क्लास के उपयोग को दर्शाता है।

आपको `arcgis` और वैकल्पिक रूप से `bs4.BeautifulSoup` के लिए ArcGIS API for Python को स्थापित करना होगा।

आप प्रमाणित डेटा लोडिंग के लिए `arcgis.gis.GIS` ऑब्जेक्ट का उपयोग कर सकते हैं, या सार्वजनिक डेटा तक पहुंचने के लिए इसे खाली छोड़ सकते हैं।
...
### ज्यामितियों को पुनर्प्राप्त करना

यदि आप फीचर ज्यामितियों को पुनर्प्राप्त करना चाहते हैं, तो आप `return_geometry` कीवर्ड का उपयोग कर सकते हैं।

प्रत्येक दस्तावेज़ की ज्यामिति उसके मेटाडेटा डिक्शनरी में संग्रहीत होगी।
