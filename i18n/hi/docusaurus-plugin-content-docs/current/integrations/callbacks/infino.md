...
>[इन्फ़िनो](https://github.com/infinohq/infino) एक स्केलेबल टेलीमेट्री स्टोर है जो लॉग्स, मेट्रिक्स और ट्रेस के लिए डिज़ाइन किया गया है। इन्फ़िनो एक स्वतंत्र अवलोकनीयता समाधान के रूप में या आपके अवलोकनीयता स्टैक में स्टोरेज लेयर के रूप में कार्य कर सकता है।

यह उदाहरण दिखाता है कि कैसे `LangChain` और [इन्फ़िनो](https://github.com/infinohq/infino) के माध्यम से OpenAI और ChatOpenAI मॉडल को कॉल करते समय निम्नलिखित को ट्रैक किया जा सकता है:

* प्रॉम्प्ट इनपुट
* `ChatGPT` या किसी अन्य `LangChain` मॉडल से प्राप्त प्रतिक्रिया
* लेटेंसी
* त्रुटियां
* खपत किए गए टोकन की संख्या
...
## इन्फ़िनो सर्वर शुरू करें, इन्फ़िनो क्लाइंट को प्रारंभ करें
...
## उदाहरण 1: LangChain OpenAI Q&A; मेट्रिक्स और लॉग को इन्फ़िनो में प्रकाशित करें
...
अब हम लेटेंसी, त्रुटियों और खपत किए गए टोकन का ग्राफ बनाने के लिए matplotlib का उपयोग करते हैं।
...
## प्रॉम्प्ट या प्रॉम्प्ट आउटपुट पर पूर्ण पाठ क्वेरी।
...
# उदाहरण 2: ChatOpenAI का उपयोग करके किसी पाठ का सारांश बनाना
