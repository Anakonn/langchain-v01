...
# Qdrant स्पार्स वेक्टर

>[Qdrant](https://qdrant.tech/) एक ओपन-सोर्स, उच्च-प्रदर्शन वेक्टर खोज इंजन/डेटाबेस है।

>`QdrantSparseVectorRetriever` [स्पार्स वेक्टर](https://qdrant.tech/articles/sparse-vectors/) का उपयोग करता है जो `Qdrant` [v1.7.0](https://qdrant.tech/articles/qdrant-1.7.x/) में पेश किए गए थे, दस्तावेज़ पुनर्प्राप्ति के लिए।

'qdrant_client' पैकेज इंस्टॉल करें:
