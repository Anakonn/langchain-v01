...
>[वीवाइट](https://weaviate.io/developers/weaviate) एक ओपन-सोर्स वेक्टर डेटाबेस है।

>[हाइब्रिड खोज](https://weaviate.io/blog/hybrid-search-explained) एक तकनीक है जो कई खोज एल्गोरिदम को मिलाकर खोज परिणामों की सटीकता और प्रासंगिकता को बेहतर बनाती है। यह कीवर्ड-आधारित खोज एल्गोरिदम और वेक्टर खोज तकनीकों के सर्वश्रेष्ठ सुविधाओं का उपयोग करता है।

>`वीवाइट में हाइब्रिड खोज` स्पार्स और घने वेक्टर का उपयोग करती है ताकि खोज क्वेरी और दस्तावेजों का अर्थ और संदर्भ प्रदर्शित किया जा सके।

यह नोटबुक दिखाता है कि `वीवाइट हाइब्रिड खोज` को LangChain रिट्रीवर के रूप में कैसे उपयोग किया जाए।
...
फ़िल्टर के साथ हाइब्रिड खोज करें:
...
स्कोर के साथ हाइब्रिड खोज करें:
