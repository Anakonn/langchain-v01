...
वॉकथ्रू में, हम `Pinecone` वेक्टर स्टोर के साथ `SelfQueryRetriever` का प्रदर्शन करेंगे।

## पाइनकोन इंडेक्स बनाना

पहले हम एक `Pinecone` वेक्टर स्टोर बनाएंगे और इसे कुछ डेटा से भरेंगे। हमने फिल्मों के सारांश वाली एक छोटी डेमो सेट बनाई है।

पाइनकोन का उपयोग करने के लिए, आपके पास `pinecone` पैकेज इंस्टॉल होना चाहिए और आपके पास एक API कुंजी और एक वातावरण होना चाहिए। यहां [इंस्टॉलेशन निर्देश](https://docs.pinecone.io/docs/quickstart) हैं।
...
अब हम अपना रिट्रीवर इंस्टैंस कर सकते हैं। ऐसा करने के लिए, हमें अपने दस्तावेजों के मेटाडेटा फ़ील्ड्स और दस्तावेज़ सामग्री का एक संक्षिप्त वर्णन प्रदान करना होगा।
