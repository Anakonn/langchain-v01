...
>[रेडिस](https://redis.com) एक ओपन-सोर्स कुंजी-मूल्य स्टोर है जिसका उपयोग कैश, संदेश ब्रोकर, डेटाबेस, वेक्टर डेटाबेस और अधिक के रूप में किया जा सकता है।

नोटबुक में, हम `रेडिस` वेक्टर स्टोर के चारों ओर `SelfQueryRetriever` का प्रदर्शन करेंगे।

## एक रेडिस वेक्टर स्टोर बनाना

पहले हम एक रेडिस वेक्टर स्टोर बनाना और इसे कुछ डेटा से भरना चाहेंगे। हमने फिल्मों के सारांश वाले छोटे डेमो सेट बनाए हैं।

**नोट:** सेल्फ-क्वेरी रिट्रीवर के लिए आपको `लार्क` स्थापित करना होगा (`pip install lark`) साथ ही एकीकरण-विशिष्ट आवश्यकताएं।
