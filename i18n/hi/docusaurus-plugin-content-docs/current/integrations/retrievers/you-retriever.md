...
>[आप.कॉम एपीआई](https://api.you.com) एक उपकरणों का समूह है जो डेवलपर्स को एलएलएम के आउटपुट को सबसे हाल के, सबसे सटीक, सबसे प्रासंगिक जानकारी से जोड़ने में मदद करता है जो उनके प्रशिक्षण डेटासेट में शामिल नहीं हो सकता था।

## सेटअप

रिट्रीवर `langchain-community` पैकेज में रहता है।

आपको अपना आप.कॉम एपीआई कुंजी भी सेट करनी होगी।
