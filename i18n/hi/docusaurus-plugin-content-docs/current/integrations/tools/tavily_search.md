...
[टेविली की खोज एपीआई](https://tavily.com) एक खोज इंजन है जो विशेष रूप से एआई एजेंटों (एलएलएम) के लिए बनाया गया है, जो वास्तविक समय, सटीक और तथ्यात्मक परिणाम तेजी से प्रदान करता है।
...
हमें अपने टेविली एपीआई कुंजी को भी सेट करना होगा।
...
[LangSmith](https://smith.langchain.com/) को सेट करना भी उपयोगी (लेकिन आवश्यक नहीं) है क्योंकि यह श्रेष्ठ-इन-क्लास पर्यवेक्षणीयता प्रदान करता है।
...
यहां हम उपकरण का व्यक्तिगत रूप से कैसे उपयोग करें, दिखाते हैं।
...
यहां हम इसका उपयोग [एजेंट](/docs/modules/agents) के एक हिस्से के रूप में कैसे करते हैं, दिखाते हैं। हम OpenAI Functions एजेंट का उपयोग करेंगे, इसलिए हमें उस के लिए आवश्यक आधारभूत संरचना को सेट अप और स्थापित करना होगा। हम [LangSmith Hub](https://smith.langchain.com/hub) का भी उपयोग करेंगे ताकि हम प्रॉम्प्ट को वहां से ले सकें, इसलिए हमें उसे भी स्थापित करना होगा।
