...
यह नोटबुक `SearxNG` खोज एपीआई का उपयोग करके वेब खोजने के बारे में चर्चा करता है।

आप [इस लिंक](https://docs.searxng.org/dev/search_api.html) पर `Searx API` पैरामीटरों के बारे में अधिक जानकारी देख सकते हैं।
...
कुछ इंजनों के लिए, यदि सीधा `उत्तर` उपलब्ध है, तो रैपर खोज परिणामों की पूरी सूची के बजाय उत्तर छाप देगा। यदि आप सभी परिणाम प्राप्त करना चाहते हैं, तो आप रैपर के `results` विधि का उपयोग कर सकते हैं।
...
SearxNG [135 खोज इंजनों](https://docs.searxng.org/user/configured_engines.html) का समर्थन करता है। आप Searx रैपर को भी कस्टम नामित पैरामीटरों के साथ अनुकूलित कर सकते हैं जो Searx खोज एपीआई को पास किए जाएंगे। नीचे के उदाहरण में हम Searx खोज एपीआई से कस्टम खोज पैरामीटरों का अधिक दिलचस्प उपयोग करेंगे।

इस उदाहरण में हम `engines` पैरामीटर का उपयोग विकिपीडिया को खोजने के लिए करेंगे।
...
`language` जैसे अन्य Searx पैरामीटर पास करना
...
## मेटाडेटा के साथ परिणाम प्राप्त करना

इस उदाहरण में हम `categories` पैरामीटर का उपयोग करके वैज्ञानिक पेपर खोजने और परिणामों को `time_range` (सभी इंजन समय सीमा विकल्प का समर्थन नहीं करते) तक सीमित करने जा रहे हैं।

हम भी मेटाडेटा सहित परिणामों को संरचित तरीके से प्राप्त करना चाहते हैं। इसके लिए हम रैपर के `results` विधि का उपयोग करेंगे।
...
इस उदाहरण में हम `it` श्रेणी में `large language models` के लिए खोज करते हैं। हम फिर उन परिणामों को फ़िल्टर करते हैं जो github से आते हैं।
...
हम सीधे `github` और अन्य स्रोत फोर्ज से परिणाम भी खोज सकते हैं।
