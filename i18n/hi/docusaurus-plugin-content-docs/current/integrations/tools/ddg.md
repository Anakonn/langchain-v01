...
यह नोटबुक DuckDuckGo खोज घटक का उपयोग करने के बारे में चर्चा करता है।
...
अधिक जानकारी (जैसे लिंक, स्रोत) प्राप्त करने के लिए `DuckDuckGoSearchResults()` का उपयोग करें।
...
आप समाचार लेख भी खोज सकते हैं। कीवर्ड ``backend="news"`` का उपयोग करें।
...
आप सीधे एक कस्टम ``DuckDuckGoSearchAPIWrapper`` को ``DuckDuckGoSearchResults`` में भी पास कर सकते हैं। इसलिए, आपके पास खोज परिणामों पर बहुत अधिक नियंत्रण है।
