...
यह नोटबुक `langchain.chat_models.ChatAnyscale` का उपयोग दिखाता है [Anyscale Endpoints](https://endpoints.anyscale.com/) के लिए।

* `ANYSCALE_API_KEY` पर्यावरण चर सेट करें
* या `anyscale_api_key` कीवर्ड तर्क का उपयोग करें
...
# आइए Anyscale Endpoints पर प्रत्येक मॉडल का परीक्षण करें
...
# हम async विधियों और ChatOpenAI द्वारा समर्थित अन्य चीजों का उपयोग कर सकते हैं

इस तरह, तीन अनुरोध केवल सबसे लंबे व्यक्तिगत अनुरोध के समान समय तक लेंगे।
