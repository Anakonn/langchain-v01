...
यह नोटबुक Manifest और LangChain का उपयोग करने के बारे में चर्चा करता है।

`manifest` के बारे में अधिक विस्तृत जानकारी और इस उदाहरण में स्थानीय huggingface मॉडल के साथ इसका उपयोग करने के लिए, देखें https://github.com/HazyResearch/manifest

[LangChain के साथ Manifest का उपयोग करने का एक और उदाहरण](https://github.com/HazyResearch/manifest/blob/main/examples/langchain_chatgpt.html)।
