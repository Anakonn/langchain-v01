...
[Cloudflare AI दस्तावेज़](https://developers.cloudflare.com/workers-ai/models/text-generation/) में उपलब्ध सभी जनरेटिव टेक्स्ट मॉडल सूचीबद्ध किए गए हैं।

Cloudflare खाता ID और API टोकन दोनों की आवश्यकता होती है। [इस दस्तावेज़](https://developers.cloudflare.com/workers-ai/get-started/rest-api/) से उन्हें प्राप्त करने का तरीका पता करें।
...
LLM चलाने से पहले प्रमाणीकरण प्राप्त करें।
