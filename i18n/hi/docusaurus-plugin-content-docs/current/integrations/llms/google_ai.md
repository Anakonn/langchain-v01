...
Langchain के साथ [Google Generative AI](https://developers.generativeai.google/) मॉडल का उपयोग करने के लिए एक गाइड। ध्यान दें: यह Google Cloud Vertex AI [integration](/docs/integrations/llms/google_vertex_ai_palm) से अलग है।

## सेटअप

Google Generative AI का उपयोग करने के लिए आपको `langchain-google-genai` Python पैकेज इंस्टॉल करना होगा और एक API कुंजी जनरेट करनी होगी। [अधिक विवरण पढ़ें](https://developers.generativeai.google/)।
...
Gemini मॉडल में डिफ़ॉल्ट सुरक्षा सेटिंग्स होती हैं जिन्हें ओवरराइड किया जा सकता है। यदि आपको अपने मॉडलों से बहुत सारी "सुरक्षा चेतावनियाँ" मिल रही हैं, तो आप मॉडल के `safety_settings` एट्रिब्यूट को ट्वीक करने का प्रयास कर सकते हैं। उदाहरण के लिए, खतरनाक सामग्री के लिए सुरक्षा अवरोधन को बंद करने के लिए, आप अपने LLM को निम्नानुसार बना सकते हैं:
...
उपलब्ध श्रेणियों और थ्रेशोल्ड्स की सूची के लिए, Google's [safety setting types](https://ai.google.dev/api/python/google/generativeai/types/SafetySettingDict) देखें।
