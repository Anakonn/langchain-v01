...
[ExLlamav2](https://github.com/turboderp/exllamav2) आधुनिक उपभोक्ता-वर्ग जीपीयू पर स्थानीय रूप से एलएलएम चलाने के लिए एक तेज़ अनुमान पुस्तकालय है।

यह जीपीटीक्यू और ईएक्सएल2 क्वांटाइज़्ड मॉडल के लिए अनुमान का समर्थन करता है, जिन्हें [Hugging Face](https://huggingface.co/TheBloke) पर एक्सेस किया जा सकता है।

यह नोटबुक `exllamav2` को LangChain के भीतर चलाने के बारे में बताता है।

अतिरिक्त जानकारी:
[ExLlamav2 उदाहरण](https://github.com/turboderp/exllamav2/tree/master/examples)

## स्थापना

आधिकारिक [doc](https://github.com/turboderp/exllamav2) देखें
इस नोटबुक के लिए, आवश्यकताएं हैं:
- python 3.11
- langchain 0.1.7
- CUDA: 12.1.0 (नीचे देखें)
- torch==2.1.1+cu121
- exllamav2 (0.0.12+cu121)

यदि आप समान exllamav2 संस्करण स्थापित करना चाहते हैं:

```shell
pip install https://github.com/turboderp/exllamav2/releases/download/v0.0.12/exllamav2-0.0.12+cu121-cp311-cp311-linux_x86_64.whl
```

यदि आप conda का उपयोग करते हैं, तो निर्भरताएं हैं:
...
आपको `API_TOKEN` की आवश्यकता नहीं है क्योंकि आप स्थानीय रूप से एलएलएम चलाएंगे।

यह समझना महत्वपूर्ण है कि इच्छित मशीन पर कौन से मॉडल उपयुक्त हैं।

[TheBloke's](https://huggingface.co/TheBloke) Hugging Face मॉडल में एक `Provided files` अनुभाग है जो विभिन्न क्वांटाइज़ेशन आकार और विधियों (उदा: [Mistral-7B-Instruct-v0.2-GPTQ](https://huggingface.co/TheBloke/Mistral-7B-Instruct-v0.2-GPTQ)) के लिए आवश्यक RAM को प्रकट करता है।
