...
दस्तावेजों को एम्बेडिंग के माध्यम से तुलना करने का लाभ है कि यह कई भाषाओं में काम करता है। "Harrison says hello" और "Harrison dice hola" लगभग समान स्थान पर होंगे क्योंकि उनका अर्थ सेमांटिकली समान है।

हालांकि, दस्तावेजों को अन्य भाषाओं में अनुवादित करने के लिए एक एलएलएम का उपयोग करना अभी भी उपयोगी हो सकता है। यह तब विशेष रूप से उपयोगी है जब उपयोगकर्ताओं से अपेक्षा की जाती है कि वे विभिन्न भाषाओं में ज्ञान आधार का प्रश्न पूछें, या जब किसी दिए गए भाषा के लिए नवीनतम एम्बेडिंग मॉडल उपलब्ध नहीं हैं।

हम [Doctran](https://github.com/psychic-api/doctran) लाइब्रेरी का उपयोग करके यह काम कर सकते हैं, जो OpenAI के फ़ंक्शन कॉलिंग फ़ीचर का उपयोग करके दस्तावेजों को भाषाओं के बीच अनुवादित करता है।
...
यह वह दस्तावेज है जिसे हम अनुवादित करेंगे
...
एक दस्तावेज को अनुवादित करने के बाद, परिणाम को लक्षित भाषा में page_content के साथ एक नए दस्तावेज के रूप में वापस लौटाया जाएगा।
