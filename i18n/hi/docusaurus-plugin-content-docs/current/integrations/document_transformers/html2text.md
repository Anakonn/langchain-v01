...
>[html2text](https://github.com/Alir3z4/html2text/) एक Python पैकेज है जो एक पृष्ठ के `HTML` को साफ, पढ़ने में आसान सादे `ASCII पाठ` में बदल देता है।

ASCII भी एक वैध `Markdown` (एक पाठ-से-HTML प्रारूप) है।
