...
[OpenVINO™](https://github.com/openvinotoolkit/openvino) एक ओपन-सोर्स टूलकिट है जो AI अनुमान को अनुकूलित और तैनात करने में मदद करता है। OpenVINO™ Runtime विभिन्न हार्डवेयर [उपकरणों](https://github.com/openvinotoolkit/openvino?tab=readme-ov-file#supported-hardware-matrix) जैसे x86 और ARM CPU, और Intel GPU का समर्थन करता है। यह कंप्यूटर विजन, ऑटोमेटिक स्पीच रिकग्निशन, प्राकृतिक भाषा प्रोसेसिंग और अन्य सामान्य कार्यों में गहरी शिक्षण प्रदर्शन को बढ़ाने में मदद कर सकता है।

Hugging Face रीरैंक मॉडल को ``OpenVINOReranker`` क्लास के माध्यम से OpenVINO द्वारा समर्थित किया जा सकता है। यदि आपके पास Intel GPU है, तो आप `model_kwargs={"device": "GPU"}` निर्दिष्ट कर सकते हैं ताकि इसे GPU पर चलाया जा सके।
...
## आधार वेक्टर स्टोर रिट्रीवर सेट करें

चलो एक सरल वेक्टर स्टोर रिट्रीवर को प्रारंभ करके और 2023 के राज्य के संघ भाषण (टुकड़ों में) को संग्रहीत करके शुरू करते हैं। हम रिट्रीवर को एक उच्च संख्या (20) में दस्तावेज़ों को पुनर्प्राप्त करने के लिए सेट कर सकते हैं।
...
## OpenVINO के साथ रीरैंकिंग

अब चलो अपने आधार रिट्रीवर को `ContextualCompressionRetriever` के साथ लपेटें, जिसमें `OpenVINOReranker` को एक संपीड़क के रूप में उपयोग किया जाता है।
...
रीरैंकिंग के बाद, शीर्ष 4 दस्तावेज़ आधार रिट्रीवर द्वारा पुनर्प्राप्त शीर्ष 4 दस्तावेज़ों से अलग हैं।
...
``OVModelForSequenceClassification`` के साथ आप अपने रीरैंक मॉडल को OpenVINO IR प्रारूप में निर्यात कर सकते हैं, और स्थानीय फोल्डर से मॉडल लोड कर सकते हैं।
