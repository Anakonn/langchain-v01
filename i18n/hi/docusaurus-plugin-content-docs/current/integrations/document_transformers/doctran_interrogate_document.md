...
# Doctran: दस्तावेजों का पूछताछ करना

वेक्टर स्टोर नॉलेज बेस में उपयोग किए जाने वाले दस्तावेज आमतौर पर कहानी या वार्तालाप प्रारूप में संग्रहीत होते हैं। हालांकि, अधिकांश उपयोगकर्ता प्रश्न प्रारूप में होते हैं। यदि हम दस्तावेजों को वेक्टराइज करने से पहले **प्रश्न और उत्तर प्रारूप में बदल दें**, तो हम प्रासंगिक दस्तावेजों को पुनर्प्राप्त करने की संभावना बढ़ा सकते हैं, और अप्रासंगिक दस्तावेजों को पुनर्प्राप्त करने की संभावना कम कर सकते हैं।

हम [Doctran](https://github.com/psychic-api/doctran) लाइब्रेरी का उपयोग करके यह कर सकते हैं, जो OpenAI के फ़ंक्शन कॉलिंग फ़ीचर का उपयोग करके दस्तावेजों को "पूछताछ" करता है।

विभिन्न प्रश्नों के लिए कच्चे दस्तावेजों और पूछताछ किए गए दस्तावेजों के लिए वेक्टर समानता स्कोर पर बेंचमार्क के लिए [यह नोटबुक](https://github.com/psychic-api/doctran/blob/main/benchmark.md) देखें।
...
यह वह दस्तावेज है जिसकी हम पूछताछ करेंगे
...
एक दस्तावेज को पूछताछ करने के बाद, परिणाम मेटाडेटा में प्रश्नों और उत्तरों के साथ एक नया दस्तावेज के रूप में वापस किया जाएगा।
