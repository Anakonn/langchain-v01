...
> [परेशान करना](https://github.com/spotify/annoy) (`Approximate Nearest Neighbors Oh Yeah`) एक C++ लाइब्रेरी है जिसमें Python बाइंडिंग्स हैं ताकि किसी दिए गए क्वेरी बिंदु के करीब के बिंदुओं को खोजा जा सके। यह बड़े पठनीय-केवल फ़ाइल-आधारित डेटा संरचनाएं भी बनाता है जो मेमोरी में mmapped हैं ताकि कई प्रक्रियाएं एक ही डेटा को साझा कर सकें।

यह नोटबुक `Annoy` वेक्टर डेटाबेस से संबंधित कार्यक्षमता का उपयोग करने का तरीका दिखाता है।

:::note
नोट: Annoy केवल पठनीय है - एक बार इंडेक्स बना दिया जाए तो आप और अधिक एम्बेडिंग्स नहीं जोड़ सकते!
यदि आप अपने VectorStore में धीरे-धीरे नई प्रविष्टियां जोड़ना चाहते हैं, तो बेहतर है कि आप किसी वैकल्पिक विकल्प का चयन करें!

```python
%pip install --upgrade --quiet  annoy
```

## पाठों से VectorStore बनाएं
...
## मौजूदा एम्बेडिंग्स के माध्यम से VectorStore बनाएं
...
## एम्बेडिंग्स के माध्यम से खोजें
...
## docstore id के माध्यम से खोजें
