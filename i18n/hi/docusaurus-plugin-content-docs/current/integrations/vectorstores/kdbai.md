...
> [KDB.AI](https://kdb.ai/) एक शक्तिशाली ज्ञान-आधारित वेक्टर डेटाबेस और सर्च इंजन है जो आपको वास्तविक समय के डेटा का उपयोग करके स्केलेबल, विश्वसनीय AI अनुप्रयोग बनाने में मदद करता है, जो उन्नत खोज, सिफारिश और व्यक्तिगतीकरण प्रदान करता है।

[यह उदाहरण](https://github.com/KxSystems/kdbai-samples/blob/main/document_search/document_search.md) दिखाता है कि अstruktured पाठ दस्तावेजों पर语义 खोज चलाने के लिए KDB.AI का कैसे उपयोग किया जा सकता है।

अपने एंडपॉइंट और API कुंजियों तक पहुंचने के लिए, [यहां KDB.AI में साइन अप करें](https://kdb.ai/get-started/)।

अपने विकास वातावरण को सेट अप करने के लिए, [KDB.AI पूर्व-आवश्यकताएं पृष्ठ](https://code.kx.com/kdbai/pre-requisites.html) पर दिए गए निर्देशों का पालन करें।

निम्नलिखित उदाहरण LangChain के माध्यम से KDB.AI के साथ कैसे बातचीत की जा सकती है, इसका प्रदर्शन करते हैं।
...
## PDF पाठ से एक वेक्टर डेटाबेस बनाएं
...
## दस्तावेज को अंग्रेजी में सारांशित करें
