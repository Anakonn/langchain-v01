...
>[लैंटर्न](https://github.com/lanterndata/lantern) `Postgres` के लिए एक ओपन-सोर्स वेक्टर समानता खोज है

यह समर्थन करता है:
- सटीक और लगभग निकटतम पड़ोसी खोज
- L2 वर्ग दूरी, हैमिंग दूरी, और कोसाइन दूरी

यह नोटबुक `Lantern` पोस्टग्रेस वेक्टर डेटाबेस का उपयोग करने का तरीका दिखाता है।

[स्थापना निर्देश](https://github.com/lanterndata/lantern#-quick-install) देखें।

हमें `OpenAIEmbeddings` का उपयोग करना है, इसलिए हमें OpenAI API कुंजी प्राप्त करनी होगी।

# आवश्यक पैकेज पिप इंस्टॉल करें
...
## कोसाइन दूरी के साथ समानता खोज (डिफ़ॉल्ट)
...
हम मौजूदा वेक्टरस्टोर में दस्तावेज जोड़ सकते हैं।
