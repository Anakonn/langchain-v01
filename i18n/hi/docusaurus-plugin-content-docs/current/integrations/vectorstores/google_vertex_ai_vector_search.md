...
# Google Vertex AI वेक्टर खोज

यह नोटबुक `Google Cloud Vertex AI वेक्टर खोज` वेक्टर डेटाबेस से संबंधित कार्यक्षमता का उपयोग करने का प्रदर्शन करता है।

> [Google Vertex AI वेक्टर खोज](https://cloud.google.com/vertex-ai/docs/vector-search/overview), पहले से ही Vertex AI मैचिंग इंजन के रूप में जाना जाता था, उद्योग की अग्रणी उच्च पैमाने की कम लेटेंसी वाली वेक्टर डेटाबेस प्रदान करता है। इन वेक्टर डेटाबेसों को आमतौर पर वेक्टर समानता-मैचिंग या एक अनुमानित निकटतम पड़ोसी (ANN) सेवा के रूप में संदर्भित किया जाता है।

**नोट**: Langchain API एक पहले से ही बनाया गया एंडपॉइंट और तैनात सूचकांक की उम्मीद करता है। सूचकांक बनाने में एक घंटे तक का समय लग सकता है।

> सूचकांक कैसे बनाएं और उसे एक एंडपॉइंट पर तैनात करें, इसके बारे में जानने के लिए [Create Index and deploy it to an Endpoint](#create-index-and-deploy-it-to-an-endpoint) खंड देखें।
यदि आपके पास पहले से ही एक तैनात सूचकांक है, तो [Create VectorStore from texts](#create-vector-store-from-texts) पर जाएं।

## सूचकांक बनाएं और उसे एक एंडपॉइंट पर तैनात करें

- यह खंड एक नया सूचकांक बनाने और उसे एक एंडपॉइंट पर तैनात करने का प्रदर्शन करता है।
...
### [VertexAIEmbeddings](https://python.langchain.com/docs/integrations/text_embedding/google_vertex_ai_palm/) को embeddings मॉडल के रूप में उपयोग करें
...
### एक खाली सूचकांक बनाएं

**नोट:** सूचकांक बनाते समय आपको "index_update_method" को या तो "BATCH_UPDATE" या "STREAM_UPDATE" से निर्दिष्ट करना चाहिए।
> बैच सूचकांक तब के लिए है जब आप अपने सूचकांक को एक बैच में अपडेट करना चाहते हैं, जिसका डेटा एक निर्धारित समय के बाद संग्रहित किया गया है, जैसे कि साप्ताहिक या मासिक रूप से प्रसंस्कृत प्रणालियां। स्ट्रीमिंग सूचकांक तब है जब आप चाहते हैं कि नया डेटा जोड़ा जाने के साथ ही आपके डेटास्टोर में सूचकांक डेटा अपडेट हो जाए, उदाहरण के लिए, यदि आपके पास एक पुस्तकालय है और आप चाहते हैं कि नई स्टॉक ऑनलाइन पर जल्द से जल्द दिखाई दे। आप किस प्रकार का चुनते हैं, यह महत्वपूर्ण है, क्योंकि सेटअप और आवश्यकताएं अलग-अलग हैं।

अधिक जानकारी के लिए [आधिकारिक दस्तावेज़](https://cloud.google.com/vertex-ai/docs/vector-search/create-manage-index#create-index-batch) देखें।
...
### सूचकांक को एंडपॉइंट पर तैनात करें
...
## पाठ से वेक्टर स्टोर बनाएं

नोट: यदि आपके पास मौजूदा सूचकांक और एंडपॉइंट हैं, तो आप नीचे दिए गए कोड का उपयोग करके उन्हें लोड कर सकते हैं।
...
### सरल वेक्टर स्टोर बनाएं (फ़िल्टर के बिना)
...
### वैकल्पिक: आप डेटास्टोर में वेक्टर और टुकड़ों को भी स्टोर कर सकते हैं
...
### मेटाडेटा फ़िल्टर के साथ वेक्टर स्टोर बनाएं
...
### प्रश्न उत्तर श्रृंखलाओं में रिट्रीवर के साथ फ़िल्टर का उपयोग करें
...
## PDF पढ़ें, टुकड़ों में बांटें, वेक्टराइज़ करें और सूचीबद्ध करें
