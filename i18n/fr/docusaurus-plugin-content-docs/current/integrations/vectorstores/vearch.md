...
>[Vearch](https://vearch.readthedocs.io) est l'infrastructure de recherche vectorielle pour les applications d'apprentissage en profondeur et d'IA.

## Configuration

Suivez les [instructions](https://vearch.readthedocs.io/en/latest/quick-start-guide.html#).
