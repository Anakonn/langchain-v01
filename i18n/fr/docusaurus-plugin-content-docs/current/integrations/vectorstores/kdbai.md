...
> [KDB.AI](https://kdb.ai/) est une puissante base de données vectorielle et un moteur de recherche basés sur les connaissances qui vous permettent de construire des applications IA évolutives et fiables, en utilisant des données en temps réel, en fournissant une recherche avancée, des recommandations et une personnalisation.

[Cet exemple](https://github.com/KxSystems/kdbai-samples/blob/main/document_search/document_search.md) montre comment utiliser KDB.AI pour effectuer une recherche sémantique sur des documents textuels non structurés.

Pour accéder à votre point de terminaison et à vos clés d'API, [inscrivez-vous à KDB.AI ici](https://kdb.ai/get-started/).

Pour configurer votre environnement de développement, suivez les instructions de la [page des prérequis de KDB.AI](https://code.kx.com/kdbai/pre-requisites.html).

Les exemples suivants montrent quelques-unes des façons dont vous pouvez interagir avec KDB.AI via LangChain.
...
## Créer une base de données vectorielle à partir du texte du PDF
...
## Résumer le document en anglais
