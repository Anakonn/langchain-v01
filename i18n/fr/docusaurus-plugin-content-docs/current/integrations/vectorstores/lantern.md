...
>[Lanterne](https://github.com/lanterndata/lantern) est une recherche de similarité vectorielle open-source pour `Postgres`

Elle prend en charge :
- Recherche de plus proches voisins exacte et approximative
- Distance carrée L2, distance de Hamming et distance de cosinus

Ce notebook montre comment utiliser la base de données vectorielle Postgres (`Lanterne`).

Voir les [instructions d'installation](https://github.com/lanterndata/lantern#-quick-install).
...
## Recherche de similarité avec la distance de cosinus (par défaut)
...
Nous pouvons ajouter des documents à l'vectorstore existant.
...
Cela supprimera la collection avant de la repeupler
