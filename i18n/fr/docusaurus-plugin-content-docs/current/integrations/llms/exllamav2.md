...
[ExLlamav2](https://github.com/turboderp/exllamav2) est une bibliothèque d'inférence rapide pour exécuter des LLM localement sur des GPU grand public modernes.

Elle prend en charge l'inférence pour les modèles quantifiés GPTQ et EXL2, qui peuvent être accessibles sur [Hugging Face](https://huggingface.co/TheBloke).

Ce notebook explique comment exécuter `exllamav2` dans LangChain.

Informations supplémentaires :
[Exemples d'ExLlamav2](https://github.com/turboderp/exllamav2/tree/master/examples)

## Installation

Reportez-vous à la [documentation officielle](https://github.com/turboderp/exllamav2)
Pour ce notebook, les exigences sont :
- python 3.11
- langchain 0.1.7
- CUDA : 12.1.0 (voir ci-dessous)
- torch==2.1.1+cu121
- exllamav2 (0.0.12+cu121)

Si vous voulez installer la même version d'exllamav2 :

```shell
pip install https://github.com/turboderp/exllamav2/releases/download/v0.0.12/exllamav2-0.0.12+cu121-cp311-cp311-linux_x86_64.whl
```

si vous utilisez conda, les dépendances sont :
...
Les modèles Hugging Face de [TheBloke](https://huggingface.co/TheBloke) ont une section `Fichiers fournis` qui expose la RAM requise pour exécuter des modèles de différentes tailles et méthodes de quantification (par exemple : [Mistral-7B-Instruct-v0.2-GPTQ](https://huggingface.co/TheBloke/Mistral-7B-Instruct-v0.2-GPTQ)).
