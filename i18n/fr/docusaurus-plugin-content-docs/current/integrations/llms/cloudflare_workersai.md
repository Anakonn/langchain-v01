...
# Travailleurs Cloudflare IA

[Documentation Cloudflare AI](https://developers.cloudflare.com/workers-ai/models/text-generation/) répertorie tous les modèles de texte génératifs disponibles.

L'ID de compte Cloudflare et le jeton API sont nécessaires. Découvrez comment les obtenir dans [ce document](https://developers.cloudflare.com/workers-ai/get-started/rest-api/).
...
Obtenez l'authentification avant d'exécuter LLM.
