...
Cet exemple explique comment utiliser LangChain pour interagir avec les [modèles](https://clarifai.com/explore/models) `Clarifai`.
...
Créez un modèle de prompt à utiliser avec la chaîne LLM :
...
Configurez l'identifiant utilisateur et l'identifiant d'application où se trouve le modèle. Vous pouvez trouver une liste des modèles publics sur https://clarifai.com/explore/models
...
Alternativement, vous pouvez utiliser l'URL du modèle (par exemple : "https://clarifai.com/anthropic/completion/models/claude-v2") pour l'initialisation.
...
## Prédiction du modèle avec des paramètres d'inférence pour GPT.

Vous pouvez également utiliser des modèles GPT avec des paramètres d'inférence (comme la température, max_tokens, etc.)
...
Générer des réponses pour une liste de prompts
