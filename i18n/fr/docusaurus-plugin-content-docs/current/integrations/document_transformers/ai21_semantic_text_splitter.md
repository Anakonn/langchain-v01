...
Cet exemple explique comment utiliser AI21SemanticTextSplitter dans LangChain.
...
Nous devons obtenir une clé API AI21 et définir la variable d'environnement AI21_API_KEY :
...
### Division de texte par sens sémantique

Cet exemple montre comment utiliser AI21SemanticTextSplitter pour diviser un texte en morceaux en fonction du sens sémantique.
...
### Division de texte par sens sémantique avec fusion

Cet exemple montre comment utiliser AI21SemanticTextSplitter pour diviser un texte en morceaux en fonction du sens sémantique, puis fusionner les morceaux en fonction de `chunk_size`.
...
### Division de texte en documents

Cet exemple montre comment utiliser AI21SemanticTextSplitter pour diviser un texte en Documents en fonction du sens sémantique. Les métadonnées contiendront un type pour chaque document.
...
### Création de documents avec des métadonnées

Cet exemple montre comment utiliser AI21SemanticTextSplitter pour créer des Documents à partir de textes et ajouter des métadonnées personnalisées à chaque Document.
...
### Division de texte en documents avec index de départ

Cet exemple montre comment utiliser AI21SemanticTextSplitter pour diviser un texte en Documents en fonction du sens sémantique. Les métadonnées contiendront un index de départ pour chaque document.
**Remarque** que l'index de départ fournit une indication de l'ordre des morceaux plutôt que l'index de départ réel de chaque morceau.
...
Cet exemple montre comment utiliser AI21SemanticTextSplitter pour diviser une liste de Documents en morceaux en fonction du sens sémantique.
