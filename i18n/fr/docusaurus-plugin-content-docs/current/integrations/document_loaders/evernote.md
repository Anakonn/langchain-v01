...
>[EverNote](https://evernote.com/) est destiné à l'archivage et à la création de notes dans lesquelles des photos, du contenu audio et des contenus web sauvegardés peuvent être intégrés. Les notes sont stockées dans des "carnets de notes" virtuels et peuvent être étiquetées, annotées, éditées, recherchées et exportées.

Ce carnet de notes montre comment charger un fichier [d'exportation](https://help.evernote.com/hc/en-us/articles/209005557-Export-notes-and-notebooks-as-ENEX-or-HTML) `Evernote` (.enex) depuis le disque.

Un document sera créé pour chaque note dans l'exportation.
