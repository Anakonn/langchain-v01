...
Ce notebook passe en revue comment charger des données à partir d'un [xorbits.pandas](https://doc.xorbits.io/en/latest/reference/pandas/frame.html) DataFrame.
