...
Cela couvre comment charger des articles de presse HTML à partir d'une liste d'URL de flux RSS dans un format de document que nous pouvons utiliser en aval.
...
Vous pouvez passer des arguments au NewsURLLoader qu'il utilise pour charger les articles.
...
Vous pouvez également utiliser un fichier OPML comme une exportation Feedly. Passez soit une URL, soit le contenu OPML.
