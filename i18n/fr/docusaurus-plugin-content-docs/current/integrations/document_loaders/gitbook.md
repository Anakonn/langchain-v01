...
Ce cahier montre comment extraire les données de page de n'importe quel `GitBook`.

```python
from langchain_community.document_loaders import GitbookLoader
```

### Charger à partir d'une seule page GitBook
...
### Charger à partir de tous les chemins d'un GitBook donné

Pour que cela fonctionne, le GitbookLoader doit être initialisé avec le chemin racine (`https://docs.gitbook.com` dans cet exemple) et avoir `load_all_paths` défini sur `True`.
