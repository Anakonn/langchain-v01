...
Ce cahier de laboratoire explique comment utiliser l'outil Google Trends pour récupérer des informations sur les tendances.

Tout d'abord, vous devez vous inscrire pour obtenir une clé `SerpApi key` sur : https://serpapi.com/users/sign_up.
...
[Vous pouvez également transmettre la clé en tant qu'argument au wrapper `serp_api_key="votre clé secrète"`]
