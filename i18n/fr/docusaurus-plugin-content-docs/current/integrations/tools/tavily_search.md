...
Voici comment utiliser l'outil individuellement.
...
Nous montrons ici comment l'utiliser dans le cadre d'un [agent](/docs/modules/agents). Nous utilisons l'agent de fonctions OpenAI, donc nous devrons configurer et installer les dépendances requises pour cela. Nous utiliserons également [LangSmith Hub](https://smith.langchain.com/hub) pour récupérer l'invite, donc nous devrons installer cela.
