...
# Outils de l'API du marché boursier Polygon

>[Polygon](https://polygon.io/) L'API Stocks de Polygon.io fournit des points de terminaison REST qui vous permettent d'interroger les dernières données de marché de toutes les bourses américaines.

Ce notebook utilise des outils pour obtenir des données de marché boursier comme la dernière cotation et les nouvelles pour un code mnémonique de Polygon.
...
### Obtenir la dernière cotation pour un code mnémonique
...
### Obtenir des agrégats (prix historiques) pour un code mnémonique
...
### Obtenir les dernières nouvelles pour un code mnémonique
...
### Obtenir les données financières pour un code mnémonique
