...
Ce notebook explique comment utiliser l'outil Brave Search.
Allez sur le [site Web de Brave](https://brave.com/search/api/) pour vous inscrire à un compte gratuit et obtenir une clé API.
