...
>[Weaviate](https://weaviate.io/developers/weaviate) est une base de données vectorielle open-source.

>[La recherche hybride](https://weaviate.io/blog/hybrid-search-explained) est une technique qui combine plusieurs algorithmes de recherche pour améliorer la précision et la pertinence des résultats de recherche. Elle utilise les meilleures caractéristiques des algorithmes de recherche basés sur les mots-clés et des techniques de recherche vectorielle.

>La `recherche hybride dans Weaviate` utilise des vecteurs épars et denses pour représenter le sens et le contexte des requêtes de recherche et des documents.

Ce notebook montre comment utiliser `la recherche hybride Weaviate` comme un récupérateur LangChain.
...
Effectuer une recherche hybride avec un filtre where :
...
Effectuer une recherche hybride avec des scores :
