...
Ce notebook couvre comment se lancer avec le `Cohere RAG` retriever. Cela vous permet de tirer parti de la capacité de rechercher des documents sur divers connecteurs ou en fournissant les vôtres.
