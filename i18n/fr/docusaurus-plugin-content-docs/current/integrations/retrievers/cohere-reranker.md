...
Ce notebook montre comment utiliser [l'endpoint de reclassement de Cohere](https://docs.cohere.com/docs/reranking) dans un récupérateur. Cela s'appuie sur les idées du [ContextualCompressionRetriever](/docs/modules/data_connection/retrievers/contextual_compression/).
...
## Configurer le récupérateur de base du magasin de vecteurs
...
## Faire du reclassement avec CohereRerank

Maintenant, enveloppons notre récupérateur de base avec un `ContextualCompressionRetriever`. Nous ajouterons un `CohereRerank`, qui utilise l'endpoint de reclassement de Cohere pour reclasser les résultats renvoyés.
...
Vous pouvez bien sûr utiliser ce récupérateur dans un pipeline de QA
