---
sidebar_label: API Llama
translated: true
---

# API ChatLlama

Ce notebook montre comment utiliser LangChain avec [LlamaAPI](https://llama-api.com/) - une version hébergée de Llama2 qui ajoute la prise en charge des appels de fonction.
