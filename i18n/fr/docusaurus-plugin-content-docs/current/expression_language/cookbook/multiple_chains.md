---
sidebar_position: 2
title: Chaînes multiples
translated: true
---

Les Runnables peuvent facilement être utilisés pour enchaîner plusieurs Chaînes
...
Vous voudrez peut-être que la sortie d'un composant soit traitée par 2 ou plusieurs autres composants. [RunnableParallels](https://api.python.langchain.com/en/latest/runnables/langchain_core.runnables.base.RunnableParallel.html#langchain_core.runnables.base.RunnableParallel) vous permettent de diviser ou de ramifier la chaîne afin que plusieurs composants puissent traiter l'entrée en parallèle. Plus tard, d'autres composants peuvent joindre ou fusionner les résultats pour synthétiser une réponse finale. Ce type de chaîne crée un graphique de calcul qui ressemble à ce qui suit :
