...
# Réorganisation du contexte long

Quelle que soit l'architecture de votre modèle, il y a une dégradation substantielle des performances lorsque vous incluez 10 documents ou plus récupérés.
En bref : lorsque les modèles doivent accéder aux informations pertinentes au milieu de longs contextes, ils ont tendance à ignorer les documents fournis.
Voir : https://arxiv.org/abs/2307.03172

Pour éviter ce problème, vous pouvez réorganiser les documents après la récupération pour éviter la dégradation des performances.
