...
CodeTextSplitter vous permet de diviser votre code avec plusieurs langages pris en charge. Importez l'énumération `Language` et spécifiez la langue.
...
Voici un exemple utilisant le PythonTextSplitter :
...
Voici un exemple utilisant le séparateur de texte JS :
...
Voici un exemple utilisant le séparateur de texte TS :
...
Voici un exemple utilisant le séparateur de texte Markdown :
...
Voici un exemple sur le texte Latex :
...
Voici un exemple utilisant un séparateur de texte HTML :
...
Voici un exemple utilisant le séparateur de texte Solidity :
...
Voici un exemple utilisant le séparateur de texte C# :
...
Voici un exemple utilisant le séparateur de texte Haskell :
...
Voici un exemple utilisant le séparateur de texte PHP :
