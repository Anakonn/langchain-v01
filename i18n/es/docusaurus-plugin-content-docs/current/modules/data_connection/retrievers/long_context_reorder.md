...
# Reordenación de contexto largo

No importa la arquitectura de tu modelo, hay una degradación sustancial del rendimiento cuando incluyes 10 o más documentos recuperados.
...
Consulta: https://arxiv.org/abs/2307.03172

Para evitar este problema, puedes reordenar los documentos después de la recuperación para evitar la degradación del rendimiento.
