...
Divide el texto en función de la similitud semántica.

Tomado del excelente cuaderno de Greg Kamradt:
...
Todo el crédito a él.

A un nivel alto, esto se divide en oraciones, luego se agrupa en grupos de 3
oraciones, y luego se fusiona uno que son similares en el espacio de incrustación.
...
Este segmentador funciona determinando cuándo "romper" las oraciones. Esto se hace buscando diferencias en los incrustaciones entre cualquier par de oraciones. Cuando esa diferencia supera cierto umbral, entonces se dividen.

Hay varias formas de determinar cuál es ese umbral.

### Percentil

La forma predeterminada de dividir se basa en el percentil. En este método, se calculan todas las diferencias entre las oraciones y luego cualquier diferencia mayor que el percentil X se divide.
...
En este método, cualquier diferencia mayor que X desviaciones estándar se divide.
...
En este método, se usa la distancia intercuartílica para dividir los fragmentos.
