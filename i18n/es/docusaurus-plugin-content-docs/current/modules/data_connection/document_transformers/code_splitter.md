...
CodeTextSplitter permite dividir su código con varios idiomas compatibles. Importe el enum `Language` y especifique el idioma.
...
Aquí hay un ejemplo usando PythonTextSplitter:
...
Aquí hay un ejemplo usando el separador de texto JS:
...
Aquí hay un ejemplo usando el separador de texto TS:
...
Aquí hay un ejemplo usando el separador de texto Markdown:
...
Aquí hay un ejemplo sobre el texto Latex:
...
Aquí hay un ejemplo usando un separador de texto HTML:
...
Aquí hay un ejemplo usando el separador de texto Solidity:
...
Aquí hay un ejemplo usando el separador de texto C#:
...
Aquí hay un ejemplo usando el separador de texto Haskell:
...
Aquí hay un ejemplo usando el separador de texto PHP:
