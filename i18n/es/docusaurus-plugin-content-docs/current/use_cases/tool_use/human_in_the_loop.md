...
Hay ciertas herramientas en las que no confiamos para que un modelo las ejecute por sí solo. Una cosa que podemos hacer en tales situaciones es requerir la aprobación humana antes de invocar la herramienta.
...
Supongamos que tenemos las siguientes herramientas (ficticias) y la cadena de llamada a herramientas:
...
Podemos agregar un simple paso de aprobación humana a nuestra función tool_chain:
