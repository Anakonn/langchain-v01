---
sidebar_position: 2
title: Cadenas múltiples
translated: true
---

Los Runnables se pueden usar fácilmente para encadenar varias Cadenas
...
Es posible que desee que la salida de un componente sea procesada por 2 o más otros componentes. [RunnableParallels](https://api.python.langchain.com/en/latest/runnables/langchain_core.runnables.base.RunnableParallel.html#langchain_core.runnables.base.RunnableParallel) le permiten dividir o bifurcar la cadena para que varios componentes puedan procesar la entrada en paralelo. Más tarde, otros componentes pueden unir o fusionar los resultados para sintetizar una respuesta final. Este tipo de cadena crea un gráfico de cálculo que se parece al siguiente:
