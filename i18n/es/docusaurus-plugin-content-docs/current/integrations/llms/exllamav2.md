...
[ExLlamav2](https://github.com/turboderp/exllamav2) es una biblioteca de inferencia rápida para ejecutar LLM localmente en GPUs de clase consumidor modernas.

Admite la inferencia de modelos cuantificados GPTQ y EXL2, a los que se puede acceder en [Hugging Face](https://huggingface.co/TheBloke).

Este cuaderno explica cómo ejecutar `exllamav2` dentro de LangChain.

Información adicional:
[Ejemplos de ExLlamav2](https://github.com/turboderp/exllamav2/tree/master/examples)

## Instalación

Consulte la [documentación oficial](https://github.com/turboderp/exllamav2)
Para este cuaderno, los requisitos son:
- python 3.11
- langchain 0.1.7
- CUDA: 12.1.0 (ver a continuación)
- torch==2.1.1+cu121
- exllamav2 (0.0.12+cu121)

Si desea instalar la misma versión de exllamav2:

```shell
pip install https://github.com/turboderp/exllamav2/releases/download/v0.0.12/exllamav2-0.0.12+cu121-cp311-cp311-linux_x86_64.whl
```

si usas conda, las dependencias son:
...
No necesitas un `API_TOKEN` ya que ejecutarás el LLM localmente.

Vale la pena entender qué modelos son adecuados para usar en la máquina deseada.

Los modelos de [TheBloke's](https://huggingface.co/TheBloke) Hugging Face tienen una sección `Archivos proporcionados` que expone la RAM requerida para ejecutar modelos de diferentes tamaños y métodos de cuantificación (por ejemplo: [Mistral-7B-Instruct-v0.2-GPTQ](https://huggingface.co/TheBloke/Mistral-7B-Instruct-v0.2-GPTQ)).
