...
Este cuaderno explica cómo usar Manifest y LangChain.

Para obtener información más detallada sobre `manifest` y cómo usarlo con modelos locales de Hugging Face como en este ejemplo, consulta https://github.com/HazyResearch/manifest

Otro ejemplo de [usar Manifest con Langchain](https://github.com/HazyResearch/manifest/blob/main/examples/langchain_chatgpt.html).
