...
# Trabajadores de Cloudflare IA

[Documentación de Cloudflare AI](https://developers.cloudflare.com/workers-ai/models/text-generation/) enumeró todos los modelos de texto generativo disponibles.

Se requieren tanto el ID de cuenta de Cloudflare como el token API. Descubra cómo obtenerlos de [este documento](https://developers.cloudflare.com/workers-ai/get-started/rest-api/).
...
Obtenga autenticación antes de ejecutar LLM.
