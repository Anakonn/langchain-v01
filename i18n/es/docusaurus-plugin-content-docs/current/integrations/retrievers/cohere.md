...
Este cuaderno cubre cómo empezar con el `Cohere RAG` recuperador. Esto le permite aprovechar la capacidad de buscar documentos a través de varios conectores o proporcionando los suyos propios.
