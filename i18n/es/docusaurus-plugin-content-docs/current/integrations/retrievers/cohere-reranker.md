...
Este cuaderno muestra cómo usar el [punto final de reordenación de Cohere](https://docs.cohere.com/docs/reranking) en un buscador. Esto se basa en las ideas del [ContextualCompressionRetriever](/docs/modules/data_connection/retrievers/contextual_compression/).
...
Comencemos inicializando un buscador de almacén de vectores simple y almacenando el discurso del Estado de la Unión de 2023 (en fragmentos). Podemos configurar el buscador para recuperar una gran cantidad (20) de documentos.
...
## Realizar reordenación con CohereRerank

Ahora envolvamos nuestro buscador base con un `ContextualCompressionRetriever`. Agregaremos un `CohereRerank`, que usa el punto final de reordenación de Cohere para reordenar los resultados devueltos.
...
Por supuesto, puedes usar este buscador dentro de una canalización de preguntas y respuestas
