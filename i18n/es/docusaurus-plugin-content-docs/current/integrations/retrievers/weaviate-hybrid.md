...
>[Weaviate](https://weaviate.io/developers/weaviate) es una base de datos de vectores de código abierto.

>[Búsqueda híbrida](https://weaviate.io/blog/hybrid-search-explained) es una técnica que combina múltiples algoritmos de búsqueda para mejorar la precisión y relevancia de los resultados de búsqueda. Utiliza las mejores características de los algoritmos de búsqueda basados en palabras clave con técnicas de búsqueda de vectores.

>La `Búsqueda híbrida en Weaviate` utiliza vectores dispersos y densos para representar el significado y el contexto de las consultas de búsqueda y los documentos.

Este cuaderno muestra cómo usar `Búsqueda híbrida de Weaviate` como un recuperador de LangChain.
...
Realizar una búsqueda híbrida con filtro where:
...
Realizar una búsqueda híbrida con puntajes:
