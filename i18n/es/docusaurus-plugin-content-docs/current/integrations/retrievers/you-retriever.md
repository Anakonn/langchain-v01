...
>[you.com API](https://api.you.com) es un conjunto de herramientas diseñadas para ayudar a los desarrolladores a basar la salida de los LLM en la información más reciente, más precisa y más relevante que puede no haber sido incluida en su conjunto de datos de entrenamiento.

## Configuración

El buscador se encuentra en el paquete `langchain-community`.
