...
# BREEBS (Conocimiento Abierto)

>[BREEBS](https://www.breebs.com/) es una plataforma de conocimiento colaborativa y abierta.
Cualquiera puede crear un Breeb, una cápsula de conocimiento, basada en archivos PDF almacenados en una carpeta de Google Drive.
...
Detrás de escena, Breebs implementa varios modelos de Generación Aumentada por Recuperación (RAG) para proporcionar de manera fluida un contexto útil en cada iteración.

## Lista de Breebs disponibles

Para obtener la lista completa de Breebs, incluida su clave (breeb_key) y descripción:
https://breebs.promptbreeders.com/web/listbreebs.
La comunidad ya ha creado docenas de Breebs que están disponibles de forma gratuita para su uso. Cubren una amplia gama de especialidades, desde química orgánica hasta mitología, así como consejos sobre seducción y finanzas descentralizadas.

## Creación de un nuevo Breeb

Para generar un nuevo Breeb, simplemente compila archivos PDF en una carpeta de Google Drive compartida públicamente e inicia el proceso de creación en el [sitio web de BREEBS](https://www.breebs.com/) haciendo clic en el botón "Crear Breeb". Actualmente puedes incluir hasta 120 archivos, con un límite total de 15 millones de caracteres.

## Ejemplo de Recuperador
