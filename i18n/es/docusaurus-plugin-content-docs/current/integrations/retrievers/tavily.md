...
# API de búsqueda de Tavily

>[API de búsqueda de Tavily](https://tavily.com) es un motor de búsqueda construido específicamente para agentes de IA (LLM), que entrega resultados en tiempo real, precisos y factuales a gran velocidad.
