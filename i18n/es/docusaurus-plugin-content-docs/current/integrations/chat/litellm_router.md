---
sidebar_label: Enrutador LiteLLM
translated: true
---
...
Este cuaderno cubre cómo comenzar a usar Langchain + la biblioteca de I/O del Enrutador LiteLLM.
...
## `ChatLiteLLMRouter` también admite funcionalidad asincrónica y de transmisión:
