...
[GPTRouter](https://github.com/Writesonic/GPTRouter) es una puerta de enlace de API de LLM de código abierto que ofrece una API universal para más de 30 modelos de LLM, visión e imagen, con respaldos inteligentes basados en el tiempo de actividad y la latencia, reintentos automáticos y transmisión.

Este cuaderno cubre cómo comenzar a usar Langchain + la biblioteca de E/S de GPTRouter.

* Establezca la variable de entorno `GPT_ROUTER_API_KEY`
* o use el argumento de palabra clave `gpt_router_api_key`
...
## `GPTRouter` también admite funcionalidad asincrónica y de transmisión:
