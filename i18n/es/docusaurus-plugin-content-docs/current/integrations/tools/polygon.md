...
# Herramientas de la API del mercado de valores de Polygon

>[Polygon](https://polygon.io/) La API de acciones de Polygon.io proporciona puntos finales de REST que le permiten consultar los últimos datos de mercado de todos los intercambios de acciones de EE. UU.

Este cuaderno utiliza herramientas para obtener datos del mercado de valores como la última cotización y las noticias de un ticker de Polygon.
...
### Obtener la última cotización para el ticker
...
### Obtener agregados (precios históricos) para el ticker
...
### Obtener las últimas noticias para el ticker
...
### Obtener los estados financieros para el ticker
