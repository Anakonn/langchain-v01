...
Este cuaderno explica cómo usar la herramienta de Búsqueda valiente.
Vaya al [sitio web de Brave](https://brave.com/search/api/) para registrarse y obtener una clave API gratuita.
