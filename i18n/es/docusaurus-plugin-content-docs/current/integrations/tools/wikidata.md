...
>[Wikidata](https://wikidata.org/) es una base de conocimiento libre y abierta que puede ser leída y editada tanto por humanos como por máquinas. Wikidata es una de las bases de conocimiento abiertas más grandes del mundo.

Primero, necesitas instalar los paquetes de Python `wikibase-rest-api-client` y `mediawikiapi`.
