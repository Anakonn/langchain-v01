...
`Infinito` permite crear `Embeddings` utilizando un Servidor de Embeddings con licencia MIT.

Este cuaderno explica cómo usar Langchain con Embeddings con el [Proyecto Github Infinito](https://github.com/michaelfeil/infinity).
...
# Opción 1: Usar infinito desde Python

#### Opcional: instalar infinito

Para instalar infinito, use el siguiente comando. Para más detalles, consulte la [Documentación en Github](https://github.com/michaelfeil/infinity).
Instale las dependencias de torch y onnx.
...
# Opción 2: Ejecutar el servidor y conectarse a través de la API

#### Opcional: Asegúrese de iniciar la instancia de Infinito
...
# Instalar el paquete infinito

%pip install --upgrade --quiet  infinity_emb[all]

Inicie el servidor, es mejor hacerlo desde una terminal separada, no dentro del Cuaderno Jupyter
...
## Incrustar sus documentos usando su instancia de Infinito
