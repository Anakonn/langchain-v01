...
[Este ejemplo](https://github.com/KxSystems/kdbai-samples/blob/main/document_search/document_search.md) demuestra cómo usar KDB.AI para ejecutar búsqueda semántica en documentos de texto no estructurados.

Para acceder a su punto final y claves de API, [regístrese en KDB.AI aquí](https://kdb.ai/get-started/).

Para configurar su entorno de desarrollo, siga las instrucciones en la [página de requisitos previos de KDB.AI](https://code.kx.com/kdbai/pre-requisites.html).

Los siguientes ejemplos demuestran algunas de las formas en que puede interactuar con KDB.AI a través de LangChain.
...
## Crear una base de datos de vectores a partir del texto del PDF
...
## Crear una canalización de LangChain
...
## Resumir el documento en español
