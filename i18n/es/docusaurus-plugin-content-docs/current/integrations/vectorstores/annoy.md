...
> [Annoy](https://github.com/spotify/annoy) (`Approximate Nearest Neighbors Oh Yeah`) es una biblioteca de C++ con enlaces de Python para buscar puntos en el espacio que están cerca de un punto de consulta dado. También crea estructuras de datos de archivo de solo lectura y de gran tamaño que se asignan en memoria para que muchos procesos puedan compartir los mismos datos.

Este cuaderno muestra cómo usar la funcionalidad relacionada con la base de datos de vectores `Annoy`.

:::note
NOTA: Annoy es de solo lectura: una vez que se construye el índice, ¡no se pueden agregar más incrustaciones!
Si desea agregar nuevas entradas de forma progresiva a su VectorStore, ¡es mejor elegir una alternativa!
...
## Crear VectorStore a través de incrustaciones existentes
...
## Buscar a través de incrustaciones
...
## Buscar a través del id de docstore
