...
# Archivo de Google Cloud Storage
...
Esto cubre cómo cargar objetos de documento desde un `objeto de archivo (blob) de Google Cloud Storage (GCS)`.
...
Si desea utilizar un cargador alternativo, puede proporcionar una función personalizada, por ejemplo:
