...
Esto cubre cómo cargar artículos de noticias HTML de una lista de URLs de feeds RSS en un formato de documento que podemos usar más adelante.
...
Pasa URLs para cargarlas en Documentos
...
Puede pasar argumentos al NewsURLLoader que usa para cargar artículos.
...
También puede usar un archivo OPML como una exportación de Feedly. Pasa una URL o el contenido OPML.
