...
Este cuaderno muestra cómo extraer datos de página de cualquier `GitBook`.

```python
from langchain_community.document_loaders import GitbookLoader
```

### Cargar desde una sola página de GitBook
...
### Cargar desde todas las rutas en un GitBook dado

Para que esto funcione, el GitbookLoader debe inicializarse con la ruta raíz (`https://docs.gitbook.com` en este ejemplo) y tener `load_all_paths` establecido en `True`.
