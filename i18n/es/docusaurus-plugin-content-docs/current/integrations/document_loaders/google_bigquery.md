...
>[Google BigQuery](https://cloud.google.com/bigquery) es un almacén de datos empresarial sin servidor y rentable que funciona a través de nubes y se escala con tus datos.
`BigQuery` es parte de la `Google Cloud Platform`.

Carga una consulta `BigQuery` con un documento por fila.
