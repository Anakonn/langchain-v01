...
Está diseñado y se espera que se use para analizar artículos académicos, donde funciona particularmente bien. Nota: si los artículos suministrados a Grobid son documentos grandes (por ejemplo, disertaciones) que exceden cierto número de elementos, es posible que no se procesen.

Este cargador usa Grobid para analizar PDF en `Documentos` que conservan los metadatos asociados con la sección de texto.

---
El mejor enfoque es instalar Grobid a través de docker, consulte https://grobid.readthedocs.io/en/latest/Grobid-docker/.

(Nota: se pueden encontrar instrucciones adicionales [aquí](/docs/integrations/providers/grobid).)

Una vez que Grobid esté en funcionamiento, puede interactuar como se describe a continuación.

Ahora, podemos usar el cargador de datos.
