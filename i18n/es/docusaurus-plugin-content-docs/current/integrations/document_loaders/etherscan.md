...
>[Etherscan](https://docs.etherscan.io/) es el principal explorador de blockchain, motor de búsqueda, plataforma de API y análisis para Ethereum, una plataforma descentralizada de contratos inteligentes.

## Resumen

El cargador `Etherscan` usa la `API de Etherscan` para cargar los historiales de transacciones bajo una cuenta específica en `Ethereum Mainnet`.

Necesitará una `clave de API de Etherscan` para proceder. La clave de API gratuita tiene un límite de 5 llamadas por segundo.

El cargador admite las siguientes seis funcionalidades:

* Recuperar transacciones normales bajo una cuenta específica en Ethereum Mainet
* Recuperar transacciones internas bajo una cuenta específica en Ethereum Mainet
* Recuperar transacciones erc20 bajo una cuenta específica en Ethereum Mainet
* Recuperar transacciones erc721 bajo una cuenta específica en Ethereum Mainet
* Recuperar transacciones erc1155 bajo una cuenta específica en Ethereum Mainet
* Recuperar el saldo de ethereum en wei bajo una cuenta específica en Ethereum Mainet

Si la cuenta no tiene transacciones correspondientes, el cargador devolverá una lista con un documento. El contenido del documento es ''.

Puede pasar diferentes filtros al cargador para acceder a las diferentes funcionalidades que mencionamos anteriormente:
...
* "erc721_transaction"
* "erc1155_transaction"
El filtro predeterminado es normal_transaction

Si tiene alguna pregunta, puede acceder a [Etherscan API Doc](https://etherscan.io/tx/0x0ffa32c787b1398f44303f731cb06678e086e4f82ce07cebf75e99bb7c079c77) o ponerse en contacto conmigo a través de i@inevitable.tech.

Todas las funciones relacionadas con los historiales de transacciones están restringidas a un máximo de 1000 historiales debido al límite de Etherscan. Puede usar los siguientes parámetros para encontrar los historiales de transacciones que necesita:

* offset: predeterminado a 20. Muestra 20 transacciones por vez
* page: predeterminado a 1. Esto controla la paginación.
* start_block: Predeterminado a 0. Los historiales de transacciones comienzan desde el bloque 0.
* end_block: Predeterminado a 99999999. Los historiales de transacciones comienzan desde el bloque 99999999
* sort: "desc" o "asc". Establecer predeterminado a "desc" para obtener las transacciones más recientes.
...
## Crear un cargador de transacciones ERC20
...
## Crear un cargador de transacciones normales con parámetros personalizados
