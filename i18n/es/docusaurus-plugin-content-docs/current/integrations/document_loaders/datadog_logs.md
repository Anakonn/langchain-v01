...
Este cargador recupera los registros de sus aplicaciones en Datadog utilizando el paquete Python `datadog_api_client`. Debe inicializar el cargador con su `clave API de Datadog` y `clave de aplicación`, y debe pasar la consulta para extraer los registros deseados.
