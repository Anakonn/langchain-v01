...
>[Infino](https://github.com/infinohq/infino) es un almacén de telemetría escalable diseñado para registros, métricas y trazas. Infino puede funcionar como una solución de observabilidad independiente o como la capa de almacenamiento en tu pila de observabilidad.

Este ejemplo muestra cómo se puede realizar un seguimiento de lo siguiente al llamar a los modelos de OpenAI y ChatOpenAI a través de `LangChain` e [Infino](https://github.com/infinohq/infino):

* entrada de solicitud
* respuesta de `ChatGPT` o cualquier otro modelo `LangChain`
* latencia
* errores
...
## Iniciar el servidor Infino, inicializar el cliente Infino
...
## Leer el conjunto de datos de preguntas
...
## Ejemplo 1: LangChain OpenAI Q&A; Publicar métricas y registros en Infino
...
Ahora usamos matplotlib para crear gráficos de latencia, errores y tokens consumidos.
...
## Consulta de texto completo en la entrada de solicitud o las salidas de la entrada de solicitud.
...
# Ejemplo 2: Resumir un texto utilizando ChatOpenAI
