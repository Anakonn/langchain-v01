...
# Doctran: interrogar documentos

Los documentos utilizados en una base de conocimientos de almacén de vectores suelen almacenarse en un formato narrativo o conversacional. Sin embargo, la mayoría de las consultas de los usuarios están en formato de pregunta. Si **convertimos los documentos al formato de preguntas y respuestas** antes de vectorizarlos, podemos aumentar la probabilidad de recuperar documentos relevantes y disminuir la probabilidad de recuperar documentos irrelevantes.

Podemos lograr esto utilizando la biblioteca [Doctran](https://github.com/psychic-api/doctran), que usa la función de llamada de OpenAI para "interrogar" documentos.

Consulte [este cuaderno](https://github.com/psychic-api/doctran/blob/main/benchmark.md) para obtener puntuaciones de similitud de vectores para diversas consultas basadas en documentos sin procesar versus documentos interrogados.
...
Este es el documento que interrogaremos
...
Después de interrogar un documento, el resultado se devolverá como un nuevo documento con preguntas y respuestas proporcionadas en los metadatos.
