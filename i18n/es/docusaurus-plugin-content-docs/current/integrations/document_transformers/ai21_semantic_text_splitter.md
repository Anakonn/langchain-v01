...
Este ejemplo explica cómo usar AI21SemanticTextSplitter en LangChain.
...
Necesitaremos obtener una clave de API de AI21 y establecer la variable de entorno AI21_API_KEY:
...
### División de texto por significado semántico

Este ejemplo muestra cómo usar AI21SemanticTextSplitter para dividir un texto en fragmentos basados en el significado semántico.
...
### División de texto por significado semántico con fusión

Este ejemplo muestra cómo usar AI21SemanticTextSplitter para dividir un texto en fragmentos basados en el significado semántico, y luego fusionar los fragmentos en función de `chunk_size`.
...
### División de texto en documentos

Este ejemplo muestra cómo usar AI21SemanticTextSplitter para dividir un texto en Documentos basados en el significado semántico. Los metadatos contendrán un tipo para cada documento.
...
Este ejemplo muestra cómo usar AI21SemanticTextSplitter para crear Documentos a partir de textos y agregar metadatos personalizados a cada Documento.
...
### División de texto en documentos con índice de inicio

Este ejemplo muestra cómo usar AI21SemanticTextSplitter para dividir un texto en Documentos basados en el significado semántico. Los metadatos contendrán un índice de inicio para cada documento.
**Nota** que el índice de inicio proporciona una indicación del orden de los fragmentos en lugar del índice de inicio real de cada fragmento.
...
Este ejemplo muestra cómo usar AI21SemanticTextSplitter para dividir una lista de Documentos en fragmentos basados en el significado semántico.
