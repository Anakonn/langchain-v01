...
Esta plantilla permite la fusión RAG mediante una reimplementación del proyecto que se encuentra [aquí](https://github.com/Raudaschl/rag-fusion).

Realiza múltiples generaciones de consultas y Reciprocal Rank Fusion para volver a clasificar los resultados de búsqueda.
...
Podemos acceder al playground en [http://127.0.0.1:8000/rag-fusion/playground](http://127.0.0.1:8000/rag-fusion/playground)
