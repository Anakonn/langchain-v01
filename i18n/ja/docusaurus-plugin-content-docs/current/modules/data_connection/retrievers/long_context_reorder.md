...
モデルのアーキテクチャに関係なく、10以上の検索ドキュメントを含める場合、パフォーマンスが大幅に低下します。
要約すると: モデルが長いコンテキストの中から関連情報にアクセスする必要がある場合、提供されたドキュメントを無視する傾向があります。
参照: https://arxiv.org/abs/2307.03172

この問題を回避するには、検索後にドキュメントを並べ替えてパフォーマンスの低下を防ぐことができます。
