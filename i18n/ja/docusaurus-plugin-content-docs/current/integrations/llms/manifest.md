...
このノートブックでは、Manifestとlangchainの使い方について説明します。

`manifest`の詳細情報と、このサンプルのようにローカルのHugging Faceモデルを使う方法については、https://github.com/HazyResearch/manifestを参照してください。

[Manifestをlangchainで使う別のサンプル](https://github.com/HazyResearch/manifest/blob/main/examples/langchain_chatgpt.html)もあります。
