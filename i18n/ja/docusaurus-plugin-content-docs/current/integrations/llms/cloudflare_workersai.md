...
[Cloudflare AI documentation](https://developers.cloudflare.com/workers-ai/models/text-generation/)に利用可能な生成テキストモデルがすべて記載されています。

CloudflareアカウントのIDとAPIトークンが必要です。[このドキュメント](https://developers.cloudflare.com/workers-ai/get-started/rest-api/)から取得する方法を確認してください。
