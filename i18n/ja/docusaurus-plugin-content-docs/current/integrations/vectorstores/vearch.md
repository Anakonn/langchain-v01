...
>[Vearch](https://vearch.readthedocs.io)は、ディープラーニングとAIアプリケーションのためのベクトル検索インフラストラクチャです。

## 設定

[instructions](https://vearch.readthedocs.io/en/latest/quick-start-guide.html#)に従ってください。
