...
>[Zilliz Cloud](https://zilliz.com/doc/quick_start)は、`LF AI Milvus®`のクラウド上の完全に管理されたサービスです。

このノートブックでは、Zilliz Cloudマネージドベクトルデータベースに関連する機能の使用方法を示します。

実行するには、`Zilliz Cloud`インスタンスが起動している必要があります。[インストール手順](https://zilliz.com/cloud)はこちらです。
