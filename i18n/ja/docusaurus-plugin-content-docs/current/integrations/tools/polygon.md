...
>[Polygon](https://polygon.io/) Polygon.ioの株式APIは、米国の全株式取引所からの最新の市場データを照会できるRESTエンドポイントを提供します。

このノートブックでは、Polygonからティッカーの最新の相場や ニュースなどの株式市場データを取得するためのツールを使用します。
