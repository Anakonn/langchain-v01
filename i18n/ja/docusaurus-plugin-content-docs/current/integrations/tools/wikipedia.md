...
>[Wikipedia](https://wikipedia.org/)は、ボランティアのコミュニティ「Wikipedians」が、MediaWikiと呼ばれるウィキベースの編集システムを使って、オープンな共同作業によって書かれ、維持されている多言語の無料のオンライン百科事典です。`Wikipedia`は、歴史上最大で最も読まれている参考文献です。

最初に、`wikipedia`Pythonパッケージをインストールする必要があります。
