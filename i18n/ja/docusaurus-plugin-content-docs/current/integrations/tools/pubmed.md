...
>[PubMed®](https://pubmed.ncbi.nlm.nih.gov/) は、`MEDLINE`、ライフサイエンス分野の雑誌、オンラインブックから、生物医学文献の3,500万件以上の引用文献で構成されています。引用文献には、PubMed Central やパブリッシャーのウェブサイトからのフルテキストへのリンクが含まれる場合があります。

このノートブックでは、`PubMed`をツールとして使う方法について説明します。
