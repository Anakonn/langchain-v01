...
このノートブックでは、Volcano Embedding クラスをロードする方法について説明します。

## API の初期化

[VolcEngine](https://www.volcengine.com/docs/82379/1099455) に基づく LLM サービスを使用するには、これらのパラメーターを初期化する必要があります。

AK、SK を環境変数で初期化するか、パラメーターで初期化することができます:
