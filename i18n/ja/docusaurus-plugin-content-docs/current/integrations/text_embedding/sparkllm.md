...
# SparkLLM テキストエンベディング

公式ウェブサイト: https://www.xfyun.cn/doc/spark/Embedding_new_api.html

このエンベディングモデルを使用するには、APIキーが必要です。 https://platform.SparkLLM-ai.com/docs/text-Embedding でユーザー登録することでAPIキーを取得できます。

SparkLLMTextEmbeddingsは2Kトークンウィンドウをサポートし、2560次元のベクトルを生成します。
