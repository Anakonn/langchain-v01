...
이 문서에서는 JPG 또는 PNG와 같은 이미지를 문서 형식으로 로드하는 방법을 다룹니다.
...
내부적으로 Unstructured는 다양한 "요소"를 만들어 텍스트의 다른 부분을 구분합니다. 기본적으로 이를 결합하지만, `mode="elements"`를 지정하여 이 구분을 유지할 수 있습니다.
