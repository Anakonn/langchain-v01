...
>[Microsoft Bing](https://www.bing.com/), 일반적으로 `Bing` 또는 `Bing 검색`이라고 불리는 웹 검색 엔진은 `Microsoft`가 소유하고 운영합니다.

이 노트북은 Bing 검색 구성 요소 사용 방법을 설명합니다.

먼저 적절한 API 키와 환경 변수를 설정해야 합니다. 설정 방법은 [여기](https://levelup.gitconnected.com/api-tutorial-how-to-use-bing-web-search-api-in-python-4165d5592a7e)에서 찾을 수 있습니다.
...
쿼리를 BingSearch에 실행하고 스니펫, 제목 및 링크 메타데이터를 반환합니다.
