...
>[Polygon](https://polygon.io/) Polygon.io 주식 API는 모든 미국 주식 거래소의 최신 시장 데이터를 쿼리할 수 있는 REST 엔드포인트를 제공합니다.

이 노트북은 Polygon에서 최신 시세와 뉴스와 같은 주식 시장 데이터를 가져오는 도구를 사용합니다.
