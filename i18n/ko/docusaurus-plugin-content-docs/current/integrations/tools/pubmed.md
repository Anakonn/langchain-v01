...
>[PubMed®](https://pubmed.ncbi.nlm.nih.gov/)은 `MEDLINE`, 생명 과학 저널 및 온라인 도서에서 35백만 건 이상의 문헌 인용문을 포함하고 있습니다. 인용문에는 PubMed Central 및 출판사 웹 사이트의 전문 콘텐츠에 대한 링크가 포함될 수 있습니다.

이 노트북에서는 `PubMed`를 도구로 사용하는 방법을 살펴봅니다.
