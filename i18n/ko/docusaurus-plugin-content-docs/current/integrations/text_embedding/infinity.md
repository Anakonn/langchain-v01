...
`Infinity`를 사용하면 MIT 라이선스가 있는 Embedding Server를 사용하여 `Embeddings`를 만들 수 있습니다.

이 노트북에서는 [Infinity Github Project](https://github.com/michaelfeil/infinity)와 함께 Langchain을 사용하여 Embeddings를 사용하는 방법을 살펴봅니다.
...
# 옵션 1: Python에서 infinity 사용하기

#### 선택 사항: infinity 설치하기

다음 명령어를 사용하여 infinity를 설치하세요. 자세한 내용은 [Github 문서](https://github.com/michaelfeil/infinity)를 참고하세요.
torch와 onnx 종속성을 설치하세요.
...
# 옵션 2: 서버를 실행하고 API를 통해 연결하기

#### 선택 사항: Infinity 인스턴스 시작하기
...
서버 시작 - 가장 좋은 방법은 Jupyter Notebook 외부의 별도 터미널에서 실행하는 것입니다.
