...
> [DataStax Astra DB](https://docs.datastax.com/en/astra/home/astra.html)는 `Apache Cassandra®`를 기반으로 구축된 서버리스 벡터 지원 데이터베이스이며, 사용하기 쉬운 JSON API를 통해 편리하게 제공됩니다.

[DataStax가 제공하는 튜토리얼](https://docs.datastax.com/en/astra/astra-db-vector/tutorials/chatbot.html)을 참고하세요.
...
자세한 내용은 [예제 노트북](/docs/integrations/vectorstores/astradb)을 참고하세요.

[DataStax가 제공하는 예제](https://docs.datastax.com/en/astra/astra-db-vector/integrations/langchain.html)를 참고하세요.
...
[사용 예제](/docs/integrations/memory/astradb_chat_message_history#example)를 참고하세요.
...
자세한 내용은 [예제 노트북](/docs/integrations/llms/llm_caching#astra-db-caches)(Astra DB 섹션)을 참고하세요.
...
자세한 내용은 [예제 노트북](/docs/integrations/llms/llm_caching#astra-db-caches)(해당 섹션)을 참고하세요.

자세한 내용은 [예제 노트북](/docs/integrations/memory/astradb_chat_message_history)을 참고하세요.
...
자세한 내용은 [예제 노트북](/docs/integrations/document_loaders/astradb)을 참고하세요.
...
자세한 내용은 [예제 노트북](/docs/integrations/retrievers/self_query/astradb)을 참고하세요.
...
자세한 내용은 [예제 노트북](/docs/integrations/stores/astradb#astradbstore)을 참고하세요.
...
자세한 내용은 [예제 노트북](/docs/integrations/stores/astradb#astradbbytestore)을 참고하세요.
