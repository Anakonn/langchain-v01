...
우리는 `Twitter API` 토큰으로 로더를 초기화해야 하며, Twitter `username`을 설정해야 합니다.

## 문서 로더

[사용 예시](/docs/integrations/document_loaders/twitter)를 참고하세요.
...
[사용 예시](/docs/integrations/chat_loaders/twitter)를 참고하세요.
