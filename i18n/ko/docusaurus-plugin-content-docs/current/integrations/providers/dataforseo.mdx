...
[DataForSEO API 액세스 로그인 및 비밀번호](https://app.dataforseo.com/register)를 받고, 이를 환경 변수(`DATAFORSEO_LOGIN` 및 `DATAFORSEO_PASSWORD`)로 설정하세요.
...
이 래퍼에 대한 자세한 연습은 [이 노트북](/docs/integrations/tools/dataforseo)을 참조하세요.
