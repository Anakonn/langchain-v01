...
>[Eden AI](https://docs.edenai.co/docs/getting-started-with-eden-ai) 사용자 인터페이스(UI)
> 는 AI 프로젝트를 처리하도록 설계되었습니다. `Eden AI Portal`을 사용하면
> 시장 최고의 엔진을 사용하여 코드 없이 AI를 수행할 수 있습니다.

## 설치 및 설정

Eden AI API에 액세스하려면 API 키가 필요합니다. [계정 생성](https://app.edenai.run/user/register)하고
[여기](https://app.edenai.run/admin/account/settings)로 이동하여 API 키를 얻을 수 있습니다.

## LLMs

[사용 예제](/docs/integrations/llms/edenai)를 참조하세요.
...
[사용 예제](/docs/integrations/chat/edenai)를 참조하세요.
...
[사용 예제](/docs/integrations/text_embedding/edenai)를 참조하세요.
...
Eden AI는 다음과 같은 다양한 작업을 수행할 수 있는 도구 목록을 제공합니다:
* 음성 인식
* 텍스트 음성 변환
* 텍스트 명시적 콘텐츠 감지
* 이미지 명시적 콘텐츠 감지
...
[사용 예제](/docs/integrations/tools/edenai_tools)를 참조하세요.
