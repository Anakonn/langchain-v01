...
>[GeoPandas](https://geopandas.org/)는 파이썬에서 지리 공간 데이터를 다루기 쉽게 만들기 위한 오픈 소스 프로젝트입니다. `GeoPandas`는 `pandas`에서 사용하는 데이터 유형을 확장하여 기하학적 유형에 대한 공간 연산을 수행할 수 있습니다.
...
[사용 예제](/docs/integrations/document_loaders/geopandas)를 참고하세요.
