...
> [KDB.AI](https://kdb.ai/)는 실시간 데이터를 사용하여 확장 가능하고 안정적인 AI 애플리케이션을 구축할 수 있도록 하는 강력한 지식 기반 벡터 데이터베이스 및 검색 엔진입니다. 고급 검색, 추천 및 개인화 기능을 제공합니다.

[이 예제](https://github.com/KxSystems/kdbai-samples/blob/main/document_search/document_search.md)는 KDB.AI를 사용하여 비정형 텍스트 문서에서 의미 검색을 수행하는 방법을 보여줍니다.

엔드포인트와 API 키에 액세스하려면 [여기에서 KDB.AI에 가입하세요](https://kdb.ai/get-started/).

개발 환경을 설정하려면 [KDB.AI 사전 요구 사항 페이지](https://code.kx.com/kdbai/pre-requisites.html)의 지침을 따르세요.

다음 예제는 LangChain을 통해 KDB.AI와 상호 작용하는 방법의 일부를 보여줍니다.
