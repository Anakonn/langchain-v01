...
>`QdrantSparseVectorRetriever`는 `Qdrant` [v1.7.0](https://qdrant.tech/articles/qdrant-1.7.x/)에 도입된 [희소 벡터](https://qdrant.tech/articles/sparse-vectors/)를 사용하여 문서 검색을 수행합니다.
