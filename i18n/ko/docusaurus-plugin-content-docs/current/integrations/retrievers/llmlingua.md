...
>[LLMLingua](https://github.com/microsoft/LLMLingua)는 compact하고 잘 훈련된 언어 모델(예: GPT2-small, LLaMA-7B)을 활용하여 프롬프트에서 비필수적인 토큰을 식별하고 제거합니다. 이 접근 방식을 통해 대규모 언어 모델(LLM)로 효율적인 추론을 수행할 수 있으며, 성능 저하를 최소화하면서 최대 20배의 압축을 달성할 수 있습니다.
...
먼저 간단한 벡터 저장소 검색기를 초기화하고 2023년 국정연설(chunks)을 저장해 보겠습니다. 검색기를 설정하여 많은 수(20개)의 문서를 검색할 수 있습니다.
...
이제 `LLMLinguaCompressor`를 압축기로 사용하여 기본 검색기를 `ContextualCompressionRetriever`로 감싸 보겠습니다.
...
이제 생성 단계에서 이를 사용하는 모습을 볼 수 있습니다.
