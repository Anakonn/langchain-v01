...
>[Tavily의 검색 API](https://tavily.com)는 실시간, 정확하고 사실적인 결과를 빠르게 제공하도록 특별히 설계된 AI 에이전트(LLM)용 검색 엔진입니다.

이를 [retriever](/docs/modules/data_connection/retrievers)로 사용할 수 있습니다. 이 통합에 특정한 기능을 보여줄 것입니다. 이를 살펴본 후에는 [관련 사용 사례 페이지](/docs/use_cases/question_answering)를 탐색하여 이 벡터 저장소를 더 큰 체인의 일부로 사용하는 방법을 배우는 것이 유용할 수 있습니다.
