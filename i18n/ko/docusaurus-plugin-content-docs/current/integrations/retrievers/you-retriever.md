...
>[당신.com API](https://api.you.com)는 LLM의 출력을 최근, 가장 정확하고 관련성 있는 정보로 기반을 잡는 데 도움이 되도록 설계된 도구 모음입니다.

## 설정

리트리버는 `langchain-community` 패키지에 있습니다.

또한 당신.com API 키를 설정해야 합니다.
...
[LangSmith](https://smith.langchain.com/)를 설정하는 것도 도움이 될 수 있습니다(필수는 아님).
