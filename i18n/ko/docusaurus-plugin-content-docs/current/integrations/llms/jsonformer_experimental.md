...
[JSONFormer](https://github.com/1rgs/jsonformer)은 Hugging Face 파이프라인 모델을 래핑하여 JSON 스키마의 일부를 구조화된 디코딩을 수행하는 라이브러리입니다.
...
***그렇게 인상적이지 않네요. JSON 형식을 전혀 따르지 않았습니다! 구조화된 디코더로 다시 시도해 보겠습니다.***
