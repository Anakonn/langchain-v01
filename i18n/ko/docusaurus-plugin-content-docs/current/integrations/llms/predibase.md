...
[Predibase](https://predibase.com/)는 선형 회귀에서 대규모 언어 모델에 이르기까지 모든 ML 모델을 학습, 미세 조정 및 배포할 수 있습니다.

이 예제는 Predibase에 배포된 모델을 사용하여 Langchain을 사용하는 방법을 보여줍니다.
...
## 미세 조정된 LLM (Predibase에서 미세 조정된 자신만의 LLM 사용)
