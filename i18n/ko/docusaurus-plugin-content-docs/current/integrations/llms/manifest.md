...
이 노트북은 Manifest와 LangChain의 사용 방법을 다룹니다.

`manifest`에 대한 더 자세한 정보와 이 예제와 같이 로컬 huggingface 모델을 사용하는 방법은 https://github.com/HazyResearch/manifest를 참조하세요.

[Manifest와 Langchain을 함께 사용하는 다른 예제](https://github.com/HazyResearch/manifest/blob/main/examples/langchain_chatgpt.html)도 있습니다.
