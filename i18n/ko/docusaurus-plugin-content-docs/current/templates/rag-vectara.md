...
이 템플릿은 vectara를 사용하여 RAG를 수행합니다.

## 환경 설정

OpenAI 모델에 액세스하려면 `OPENAI_API_KEY` 환경 변수를 설정하세요.

또한 다음 환경 변수도 설정해야 합니다:
* `VECTARA_CUSTOMER_ID`
* `VECTARA_CORPUS_ID`
* `VECTARA_API_KEY`
...
[http://127.0.0.1:8000/rag-vectara/playground](http://127.0.0.1:8000/rag-vectara/playground)에서 playground에 액세스할 수 있습니다.
