...
이 템플릿은 SingleStoreDB를 벡터 저장소로 사용하며, `SINGLESTOREDB_URL`이 설정되어 있어야 합니다. 이 URL은 `admin:password@svc-xxx.svc.singlestore.com:port/db_name` 형식이어야 합니다.
...
[http://127.0.0.1:8000/rag-singlestoredb/playground](http://127.0.0.1:8000/rag-singlestoredb/playground)에서 playground에 액세스할 수 있습니다.
