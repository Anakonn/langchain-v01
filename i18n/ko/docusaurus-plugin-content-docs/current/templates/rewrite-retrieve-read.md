...
이 템플릿은 [Query Rewriting for Retrieval-Augmented Large Language Models](https://arxiv.org/pdf/2305.14283.pdf) 논문에서 RAG를 최적화하기 위한 쿼리 변환(재작성) 방법을 구현합니다.
...
[http://127.0.0.1:8000/rewrite_retrieve_read/playground](http://127.0.0.1:8000/rewrite_retrieve_read/playground)에서 playground에 액세스할 수 있습니다.
