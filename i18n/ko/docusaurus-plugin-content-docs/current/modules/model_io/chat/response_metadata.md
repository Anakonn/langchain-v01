...
많은 모델 제공업체들은 채팅 생성 응답에 일부 메타데이터를 포함합니다. 이 메타데이터는 `AIMessage.response_metadata: Dict` 속성을 통해 접근할 수 있습니다. 모델 제공업체와 모델 구성에 따라 [토큰 수](/docs/modules/model_io/chat/token_usage_tracking/), [로그 확률](/docs/modules/model_io/chat/logprobs/) 등의 정보가 포함될 수 있습니다.

여러 제공업체의 응답 메타데이터 예시는 다음과 같습니다:
