---
canonical: https://python.langchain.com/v0.1/docs/integrations/toolkits/cassandra_database
translated: false
---
...
For a deepdive on creating a Cassandra DB agent see the [CQL agent cookbook](https://github.com/langchain-ai/langchain/blob/master/cookbook/cql_agent.md)