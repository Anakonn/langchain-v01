---
canonical: https://python.langchain.com/v0.1/docs/integrations/document_transformers/doctran_interrogate_document
translated: false
---
...
See [this notebook](https://github.com/psychic-api/doctran/blob/main/benchmark.md) for benchmarks on vector similarity scores for various queries based on raw documents versus interrogated documents.
