---
canonical: https://python.langchain.com/v0.1/docs/integrations/vectorstores/kdbai
translated: false
---
...
[This example](https://github.com/KxSystems/kdbai-samples/blob/main/document_search/document_search.md) demonstrates how to use KDB.AI to run semantic search on unstructured text documents.
